...
/*  String? passmessage() {
  ...
  void initState() {
    ...
    WidgetsBinding.instance
        .addPostFrameCallback((_) => commonsettingApi(context));
    // main();
    setState(() {});
  }
                                ...
                                return Column(
                                  children: [
                                    ...
                                    /*   Container(
                                       ...
                                       child: Align(
                                           alignment: Alignment.centerLeft,
                                           child: Text("Email",textAlign:TextAlign.start,style: TextStyle(fontSize: 12,color:Colors.black38,fontFamily: "assets/fonts/raleway/Raleway-Medium.ttf"),)),
                                    ...
                                    /*  Column(
                                       children: [
                                         ...
                                         isemailerror == true  ?  Container(
                                           ...
                                           alignment:  Alignment.topLeft,
                                           child: Text(emailerror,style: TextStyle(color: MyColors.red,fontWeight: FontWeight.w600,fontSize: 12,fontFamily: "assets/fonts/raleway/Raleway-SemiBold.ttf"),),
                                         ) : Container()
                                       ],
                                     ),*/
                                              ...
                                              child: TextField(
                                                ...
                                                onTap: () {
                                                  ...
                                                  confPassfillcolor = MyColors
                                                      .lightblueColor
                                                      .withOpacity(0.03);
                                                  fullnamebordercolor = MyColors
                                                      .lightblueColor
                                                      .withOpacity(0.03);
                                                  fullnamefillcolor = MyColors
                                                      .lightblueColor
                                                      .withOpacity(0.03);
                                                  lastnamebordercolor = MyColors
                                                      .lightblueColor
                                                      .withOpacity(0.03);
...
*/
                                              ...
                                              if (!RegExp('.*[A-Z].*').hasMatch(
                                                ...
                                                validation_str =
                                                    validation_strconfPass =
                                                        'Input should contain an (uppercase) ';
                                                is_validate = false;
                                                setState(() {});
                                              }
                                              if (!RegExp('.*[a-z].*').hasMatch(
                                              ...
                                              if (!RegExp('.[!@#\$&*~].*')
                                                ...
                                                if (is_validate) {
                                                  ...
                                                  validation_str =
                                                      '$validation_str,(special character)';
                                                  setState(() {});
                                                }
                                                is_validate = false;
                                                ispasserror = true;
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: IconButton(
            ...
            onPressed: () {
              setState(() {
                debugPrint('_isObscure >>>>>>>>>>$_isObscure');
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: IconButton(
            ...
            onPressed: () {
              setState(() {
                debugPrint('_isObscure >>>>>>>>>>$_isObscure2');
  ...
  Future<void> chkEmailAndRefferalCodeapi(
    ...
    if (referralId.isNotEmpty) {
      request['referral_id'] = referralId;
    }
    ...
    var response = await http.post(
      Uri.parse(Apiservices.chkEmailAndRefferalCodeapi),
               ...
               child: SingleChildScrollView(
                 child: Column(
                   ...
                   children: [
                     ...
                     Align(
                       alignment: Alignment.center,
                         child: Text("Getting Started",style: TextStyle(fontSize: 26,color: MyColors.blackColor,fontFamily: "assets/fonts/raleway/raleway_bold.ttf"),)),
                     Column(
                       mainAxisAlignment: MainAxisAlignment.start,
                       crossAxisAlignment: CrossAxisAlignment.start,
                       children: [
                                 ...
                                 return Column(
                                   children: [
                                     ...
                                     Container(
                                       ...
                                       child: Align(
                                           alignment: Alignment.centerLeft,
                                           child: Text("Full Name",textAlign:TextAlign.start,style: TextStyle(fontSize: 12,color:Colors.black38,fontFamily: "assets/fonts/raleway/raleway_medium.ttf"),)),
                                     ...
                                     Column(
                                       children: [
                                         ...
                                         isfullnameerror == true  ?  Container(
                                           padding:EdgeInsets.only(left: 25,right: 20,top: 10) ,
                                           alignment:  Alignment.topLeft,
                                           child: Text(nameerror,style: TextStyle(color: MyColors.red,fontWeight: FontWeight.w600,fontSize: 12,fontFamily: "assets/fonts/raleway/raleway_semibold.ttf"),),
                                         ) : Container()
                                       ],
                                     ),
...
/*   Container(
                                       ...
                                       child: Align(
                                           alignment: Alignment.centerLeft,
                                           child: Text("Email",textAlign:TextAlign.start,style: TextStyle(fontSize: 12,color:Colors.black38,fontFamily: "assets/fonts/raleway/raleway_medium.ttf"),)),
...
/*  Column(
                                       children: [
                                         ...
                                         isemailerror == true  ?  Container(
                                           padding:EdgeInsets.only(left: 25,right: 20,top: 10) ,
                                           alignment:  Alignment.topLeft,
                                           child: Text(emailerror,style: TextStyle(color: MyColors.red,fontWeight: FontWeight.w600,fontSize: 12,fontFamily: "assets/fonts/raleway/raleway_semibold.ttf"),),
                                         ) : Container()
                                       ],
                                     ),*/ /*
                                     ...
                                     Container(
                                       ...
                                       child: Align(
                                           alignment: Alignment.centerLeft,
                                           child: Text("Password",textAlign:TextAlign.start,style: TextStyle(fontSize: 12,color:Colors.black38,fontFamily: "assets/fonts/raleway/raleway_medium.ttf"),)),
                                       ...
                                       child: Column(
                                         children: [
                                           ...
                                           ispasserror == true  ?  Container(
                                             padding:EdgeInsets.only(left: 25,right: 20,top: 10) ,
                                             alignment:  Alignment.topLeft,
                                             child: Text(passerror,style: TextStyle(color: MyColors.red,fontWeight: FontWeight.w600,fontSize: 12,fontFamily: "assets/fonts/raleway/raleway_semibold.ttf"),),
                                           ) : Container()
                                         ],
                                       ),
                                     ),
                                     ...
                                     Padding(
                                       ...
                                       child: Align(
                                         ...
                                         alignment: Alignment.center,
                                         child: ElevatedButton(
                                           child: Text('Getting Started',style: TextStyle(fontSize: 18,fontFamily: "assets/fonts/maven/mavenpro_bold.ttf"),),
                                           onPressed: () {
                                             RegExp regex=RegExp(r'^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[!@#\$&*~]).{8,}$');
                         ...
                         Padding(
                           ...
                           child: GestureDetector(
                             ...
                             child: Row(
                               ...
                               mainAxisAlignment: MainAxisAlignment.center,
                               children: [
                                 Text("By clicking, I'm agree with ",style: TextStyle(color: MyColors.color_text,fontSize:13,fontFamily: "assets/fonts/raleway/raleway_semibold.ttf"),),
                                 Text("Terms & Policy",style: TextStyle(color: MyColors.lightblueColor,fontSize:13,fontFamily: "assets/fonts/raleway/raleway_semibold.ttf" ),)
                               ],
                             ),
                           ),
                         ),
                         ...
                         Align(
                           ...
                           child: GestureDetector(
                             ...
                             child: Container(
                                 ...
                                 child: Text("Sign in",style: TextStyle(color: MyColors.color_3F84E5,fontSize:16,fontFamily: "assets/fonts/raleway/raleway_bold.ttf"),)
                             ),
                           ),
                         ),
                         hSizedBox4
