...
class _BankAccountNumberState extends State<BankAccountNumber> {
  ...
  Future<void> loadPref() async {
    ...
    debugPrint('partnerPaymentMethod>>> $partnerPaymentMethod');
...
*/
  ...
  static Future<void> AddBankAccountfieldFieldRequest2(
    BuildContext context,
    ...
    if (response.statusCode == 201) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => const SelectDeliveryAddMethodScreen(),
        ),
      );
    } else {
  ...
  Future<void> addRecipientBankAccountapi(
    ...
    if (jsonResponse['status'] == true) {
      ...
      if (partnerPaymentMethod == 'juba') {
        debugPrint("bdjkdshjgh${jsonResponse["data"]["juba_NominatedCode"]}");
        p.setString(
          'juba_NominatedCode',
          jsonResponse['data']['juba_NominatedCode'].toString(),
        );
      }
