...
class ChangePasswordScreen extends StatefulWidget {
  final String mobileno, countrycode, otp;
...
class _ChangePasswordScreenState extends State<ChangePasswordScreen> {
  ...
  resetpasswordApi() async {
    ...
    await Webservices.resetPasswordRequest(
      context,
      widget.mobileno,
      widget.countrycode,
      widget.otp,
                              ...
                              decoration: InputDecoration(
                                suffixIcon: IconButton(
                                  ...
                                  onPressed: () {
                                    setState(() {
                                      debugPrint(
                                        '_isObscure >>>>>>>>>>$_isObscure_confirmpass',
                                      );
                                      _isObscure_confirmpass =
                                          !_isObscure_confirmpass;
                                    });
                              ...
                              : ElevatedButton(
                                  onPressed: () {
                                    ...
                                    if (passController.text.isEmpty) {
                                      ...
                                      setState(() {});
                                    } else if (confirm_passController
                                        .text.isEmpty) {
                                      confirm_passbordercolor = MyColors.red;
                                      cinfirmpassfillcolor =
                                          MyColors.red.withOpacity(0.03);
                                      ispasserror = false;
                                      isconfirm_passerror = true;
                                      confirm_passerror =
                                      ...
                                      confirm_passbordercolor = MyColors
                                          .lightblueColor
                                          .withOpacity(0.03);
