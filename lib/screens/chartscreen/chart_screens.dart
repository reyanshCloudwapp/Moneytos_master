...
import 'package:moneytos/screens/customScreens/customchart_cartList/customChart_cardList.dart';
...
class _ChartScreenState extends State<ChartScreen> {
  ...
  final List<Color> gredient = [
    const Color(0xc2003b73),
    const Color(0xc20fe1c2)
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: [
                        ...
                        MyColors.lightblueColor.withOpacity(0.04)
                      ],
                    ),
                  ),
      ...
      body: _enabled == true
          ...
          : ListView.builder(
              itemCount: chartdatalist.isNotEmpty
                  ? chartdatalist[0].recipientData!.length
                  : chartRecipientDatlist.length,
              ...
              itemBuilder: (context, int index) {
                return Container(
                  ...
                  child: chartdatalist.isNotEmpty
                      ? CustomChartCardList(
                          recipient_name: chartdatalist[0]
                              .recipientData![index]
                              .recipientName
                              .toString(),
                          img: chartdatalist[0]
                              ...
                              .profileImage
                              .toString(),
                          amount: chartdatalist[0]
                              .recipientData![index]
                              .totalSendAmount
                              .toString(),
                          totalamount: chartdatalist.isNotEmpty
                              ? chartdatalist[0].totalSendAmount.toString()
                              : '',
                        )
                      : const Text('No Recipient'),
                );
              },
            )
  ...
  LineChartBarData get lineChartBarData2_2 => LineChartBarData(
        ...
        belowBarData: BarAreaData(
          ...
          gradient: LinearGradient(
            ...
            colors: [
              MyColors.lightblueColor.withOpacity(0.60),
              MyColors.lightblueColor.withOpacity(0.04)
            ],
          ),
        ),
        spots: chartdatalist.isNotEmpty
            ? List.generate(
                txnGraphDatalist.length,
                (index) => FlSpot(
                  double.parse(txnGraphDatalist[index].month.toString()),
                  double.parse(
                    txnGraphDatalist[index].totalSendAmount.toString(),
                  ),
                ),
              ).toList()
