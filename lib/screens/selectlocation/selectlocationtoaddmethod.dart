...
class SelectLocationToAddMethodScreen extends StatefulWidget {
  const SelectLocationToAddMethodScreen({super.key});

  @override
  State<SelectLocationToAddMethodScreen> createState() =>
      _SelectLocationToAddMethodScreenState();
}

class _SelectLocationToAddMethodScreenState
    extends State<SelectLocationToAddMethodScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text(
          MyString.Select_Location_method,
          style: TextStyle(
