...
import 'package:moneytos/screens/ScheduledTransferScreens/edit_sheduled_trnsferScreen.dart';
import 'package:moneytos/services/s_Api/S_ApiResponse/ScheduleDetailResponse.dart';
...
class _TransferSheduleBottomState extends State<TransferSheduleBottom> {
  ...
  ScheduleDetailResponse scheduleDetailResponse = ScheduleDetailResponse();
  ...
  void mainweelkly() {
    ...
    for (int i = 0; i < days.length; i++) {
      if ((i % 7) == 0) {
        ...
        debugPrint('weekly dates>>>>> $weeklydateList');
      }
    }
  ...
  void mainmonthly() {
    ...
    for (int i = 0; i < days.length; i++) {
      debugPrint(
        'all dates forenfflksg>>>> ${Utility.DatefomatToMonth(days[i].toString())}',
      );
      if (Utility.DatefomatToMonth(days[i].toString()) == 'Jan') {
        debugPrint('dates>>>>> ${days[i]}');
        if ((i % 31) == 0) {
                    ...
                    child: Column(
                      children: [
                              ...
                              children: [
                                scheduleDetailResponse
                                    ...
                                    ? CalenderList(
                                        ...
                                        Utility.DatefomatToMonth(
                                          startDate.toString(),
                                        ),
                                        Utility.DatefomatToDDMMYYYY(
                                          startDate.toString(),
                                        ),
                                      )
                                    : scheduleDetailResponse.data!.scheduledata!
                                                .scheduleType ==
                                            'Daily'
                                        ? Container(
                                            alignment: Alignment.centerLeft,
                                            ...
                                            ? Container(
                                                ...
                                                child: ListView.builder(
                                                  ...
                                                  scrollDirection:
                                                      Axis.horizontal,
                                                  itemCount:
                                                      weeklydateList.length,
                                                  itemBuilder: (
                                                    BuildContext context,
                                                    int index,
                                                  ) {
                                                    return CalenderList(
                                                      weeklydateList[index]
                                                          .day
                                                          .toString(),
                                                      Utility.DatefomatToMonth(
                                                        weeklydateList[index]
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      scheduleDetailResponse.data!.scheduledata!
                                                  ...
                                                  .toString() ==
                                              'card'
                                          ? 'Card - ${scheduleDetailResponse.data!.scheduledata!.senderSendMethodLast4digit.toString()}'
                                          : 'Account - ${scheduleDetailResponse.data!.scheduledata!.senderSendMethodLast4digit.toString()}',
                                      style: const TextStyle(
                                        fontSize: 12,
                                        fontWeight: FontWeight.w500,
                                        fontFamily:
                        ...
                        Container(
                          padding: const EdgeInsets.symmetric(horizontal: 20),
                          child: Text(
                            'All scheduled transfer will be processed at 4pm CST. Transfers scheduled after 4 pm CST will be processed the following day at 4pm CST.‏',
              ...
              CircleAvatar(
                ...
                child: ClipRRect(
                  ...
                  child: FadeInImage(
                    ...
                    fit: BoxFit.fill,
                    image: NetworkImage(
                      scheduleDetailResponse.data!.scheduledata!.recipientImage
                          .toString(),
                    ),
                    placeholder:
                    ...
                    imageErrorBuilder: (context, error, stackTrace) {
                      return Container(
                        ...
                        child: Text(
                          scheduleDetailResponse
                              .data!.scheduledata!.recipientName
                              .toString()[0]
                              .toUpperCase(),
                          style: const TextStyle(
                        ...
                        children: [
                          scheduleDetailResponse
                              ...
                              : InkWell(
                                  onTap: () {
                                    pushNewScreen(
                                      context,
                                      screen: EditSheduledTransferScreen(
                                        schedule_id:
                          ...
                          InkWell(
                            onTap: () {
                              dialogDelete(
                                context,
                                scheduleDetailResponse.data!.scheduledata!.id
                                    .toString(),
                              );
                            },
                            child: SizedBox(
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: Text(
                          scheduleDetailResponse
                              .data!.scheduledata!.recipientRecivedAmount
                              .toString(),
                          style: const TextStyle(
                            color: MyColors.blackColor,
                            fontSize: 14,
                      ...
                      Container(
                        ...
                        child: Text(
                          scheduleDetailResponse
                              .data!.scheduledata!.receivingCurrency
                              .toString(),
                          style: const TextStyle(
                            color: MyColors.blackColor,
                            fontSize: 8,
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: Text(
                          scheduleDetailResponse
                              .data!.scheduledata!.trasnsferReason
                              .toString(),
                          style: const TextStyle(
                            color: MyColors.blackColor,
                            fontSize: 13.60,
              ...
              Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      scheduleDetailResponse
                                  .data!.scheduledata!.senderSendMethod
                                  .toString() ==
                              'check'
                          ? 'Bank Account'
                          : scheduleDetailResponse
              ...
              Column(
                ...
                children: [
                  Container(
                    ...
                    child: Text(
                      scheduleDetailResponse
                          .data!.scheduledata!.recipientReceiveMethod
                          .toString(),
                      style: const TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.w700,
                  ...
                  Container(
                    alignment: Alignment.topLeft,
                    child: Text(
                      '****${scheduleDetailResponse.data!.scheduledata!.recipientReceiveMethodLast4digit}',
                      style: TextStyle(
                        fontSize: 12,
                        fontWeight: FontWeight.w400,
                        fontFamily:
  ...
  CalenderList(String date, String month, String CheckDate) {
    debugPrint('CheckDate>> $CheckDate');
    return Container(
      padding: const EdgeInsets.symmetric(
        horizontal: 5,
      ),
          ...
          child: Column(
            children: [
              Text(
                date,
                style: TextStyle(
                  color: MyColors.lightblueColor.withOpacity(0.50),
                  fontWeight: FontWeight.w700,
                  fontFamily: 'assets/fonts/montserrat/Montserrat-Bold.otf',
                  fontSize: 18,
                ),
              ),
              hSizedBox,
              ...
              hSizedBox,
              scheduleDetailResponse
                      .data!.scheduledata!.scheduleDatesOnpaymentdone!
                      .contains(CheckDate)
                  ? SvgPicture.asset(
              ...
              Row(
                children: [
                  Container(
                    alignment: Alignment.topLeft,
                    child: Text(
                      scheduleDetailResponse.data!.scheduledata!.sendAmount
                          .toString(),
                      style: const TextStyle(
                        color: MyColors.blackColor,
                        fontSize: 14,
                  ...
                  Container(
                    alignment: Alignment.topLeft,
                    child: Text(
                      scheduleDetailResponse.data!.scheduledata!.sendingCurrency
                          .toString(),
                      style: const TextStyle(
                        color: MyColors.blackColor,
                        fontSize: 8,
              ...
              Row(
                children: [
                  Container(
                    alignment: Alignment.topLeft,
                    child: Text(
                      scheduleDetailResponse.data!.scheduledata!.monyetosfee
                          .toString(),
                      style: const TextStyle(
                        color: MyColors.blackColor,
                        fontSize: 14,
                ...
                children: [
                  Container(
                    ...
                    child: Text(
                      (double.parse(
                                scheduleDetailResponse
                                    .data!.scheduledata!.sendAmount
                                    .toString(),
                              ) +
                              double.parse(
                                scheduleDetailResponse
                                    .data!.scheduledata!.monyetosfee
                                    .toString(),
                              ))
                          .toString(),
                      style: const TextStyle(
  ...
  Future<void> changeScheduleStatusapi(
    BuildContext context,
    schedule_id,
  ) async {
    ...
    var response = await http.post(
      Uri.parse(Apiservices.changeScheduleStatusapi),
  ...
  Future<void> deleteScheduleapi(
    ...
    var response = await http.post(
      Uri.parse(Apiservices.deleteScheduleapi),
      body: jsonEncode(request),
      headers: {
  ...
  Future<void> scheduleDetailapi(
    ...
    var response = await http.get(
      Uri.parse(
        '${Apiservices.scheduleDetailapi}?schedule_id=${widget.schedule_id}',
      ),
      // body: jsonEncode(request),
      headers: {
        'X-AUTHTOKEN': "${sharedPreferences.getString("auth")}",
    ...
    if (jsonResponse['status'] == true) {
      isload = false;
      scheduleDetailResponse = ScheduleDetailResponse.fromJson(jsonResponse);

      isSwitched_pin =
          scheduleDetailResponse.data!.scheduledata!.scheduleStatus == 'ON'
              ? true
              : false;

      startDate = DateTime(
        int.parse(
          scheduleDetailResponse.data!.scheduledata!.scheduleDate
              .toString()
              .split('-')[0],
        ),
        int.parse(
      ...
      if (scheduleDetailResponse.data!.scheduledata!.scheduleExpDate != null) {
        endDate = DateTime(
          int.parse(
            scheduleDetailResponse.data!.scheduledata!.scheduleExpDate
                .toString()
                .split('-')[0],
          ),
          int.parse(
      ...
      if (scheduleDetailResponse.data!.scheduledata!.scheduleType == 'Daily') {
        main();
      } else if (scheduleDetailResponse.data!.scheduledata!.scheduleType ==
          'Weekly') {
        mainweelkly();
      } else {
        mainmonthly();
      ...
      debugPrint(
        'payment done dates>>>>> ${scheduleDetailResponse.data!.scheduledata!.scheduleDatesOnpaymentdone}',
      );
      setState(() {});
    } else {
      isload = false;
  ...
  Future<void> cancelScheduleapi(
    ...
    var response = await http.post(
      Uri.parse(Apiservices.cancelScheduleapi),
      body: jsonEncode(request),
      headers: {
        'X-AUTHTOKEN': "${sharedPreferences.getString("auth")}",
        'X-USERID': "${sharedPreferences.getString("userid")}",
