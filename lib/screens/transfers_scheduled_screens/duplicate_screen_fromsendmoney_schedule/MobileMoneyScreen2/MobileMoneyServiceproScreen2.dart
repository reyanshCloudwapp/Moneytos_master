...
import 'package:moneytos/screens/transfers_scheduled_screens/duplicate_screen_fromsendmoney_schedule/MobileMoneyScreen2/MobileMoneypinServiceProScreen2.dart';
import 'package:moneytos/utils/import_helper.dart';

class MobileMoneyServiceProScreen2 extends StatefulWidget {
  const MobileMoneyServiceProScreen2({super.key});

  @override
  State<MobileMoneyServiceProScreen2> createState() =>
      _MobileMoneyServiceProScreen2State();
}

class _MobileMoneyServiceProScreen2State
    extends State<MobileMoneyServiceProScreen2> {
  ///Textfield contrller
                            ...
                            return GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        const MobileMoneypinServiceProScreen2(),
                                  ),
                                );
                              },
                              child: Container(
