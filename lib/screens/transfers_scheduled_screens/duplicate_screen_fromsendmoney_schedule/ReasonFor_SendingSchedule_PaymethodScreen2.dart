import 'package:moneytos/screens/transfers_scheduled_screens/duplicate_screen_fromsendmoney_schedule/LinkNew_ScedulePayment_MethodScreen2.dart';
...
class ReasonForSendingPaymethodScreen2 extends StatefulWidget {
  ...
  @override
  State<ReasonForSendingPaymethodScreen2> createState() =>
      _ReasonForSendingPaymethodScreen2State();
}

class _ReasonForSendingPaymethodScreen2State
    extends State<ReasonForSendingPaymethodScreen2> {
  @override
                              ...
                              GestureDetector(
                                onTap: () {
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          LinkNewScedulePaymentMethodScreen2(
                                        isMfs: widget.isMfs,
                                      ),
                                    ),
                                  );
