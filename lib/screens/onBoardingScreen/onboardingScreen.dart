...
class _OnBoardingPageState extends State<OnBoardingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //     //       SvgPicture.asset("assets/images/send.svg",height: 20,width: 20,color: MyColors.blackColor,),
      //     //       wSizedBox1,
      //     //       Text(
      //     //         MyString.app_name,
                ...
                Container(
                  ...
                  child: i == 1
                      ...
                      : const GFLoader(
                          ...
                          child: Image(
                            image: AssetImage(
                              'assets/images/onboarding_img/logo_onboarding_anim.gif',
                            ),
