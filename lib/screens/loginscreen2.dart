                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Padding(
                              padding:
                                  const EdgeInsets.only(right: 18.0, top: 16.0),
                              child: Align(
                          ...
                          Column(
                            children: [
                              ...
                              ismobileerror == true ?  Container(
                                ...
                                alignment: Alignment.topLeft,
                                child: Text(mobileerror,style: TextStyle(color: MyColors.red,fontSize: 12,fontFamily: "assets/fonts/raleway/raleway_semibold.ttf",fontWeight: FontWeight.w600),),)
                                  : Container()
                          ...
                          Column(
                            children: [
                              ...
                              ispasserror == true ?  Container(
                                margin:  EdgeInsets.fromLTRB(25.0, 5.0, 16.0, 0.0),
                             alignment: Alignment.topLeft,
                           child: Text(passerror,style: TextStyle(color: MyColors.red,fontSize: 12,fontFamily: "assets/fonts/raleway/raleway_semibold.ttf",fontWeight: FontWeight.w600),),)
                           : Container()
                              */
/*   new FlutterPwValidator(
                                  controller: passController,
                              ...
                              alignment: Alignment.centerRight,
                                child: GestureDetector(
                                  onTap: (){
                                    ...
                                    child: Text("Forgot Password !",style: TextStyle(color: MyColors.color_3F84E5,fontSize:14,fontWeight: FontWeight.w400,fontFamily: "assets/fonts/poppins_regular.ttf" ),))),
                          ),
                            ...
                            child: Align(
                              ...
                              child: load == true ? CircularProgressIndicator(color: MyColors.lightblueColor,) : ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                    ...
                                    textStyle: TextStyle(
                                        fontSize: 18,
                                        fontFamily: "assets/fonts/maven/mavenpro_bold.ttf",
                                        fontWeight: FontWeight.bold)),
                              ),
                            ),
                          ),
                       ...
                       SizedBox(
                         height: 80,
                          ...
                          Align(
                            alignment: Alignment.center,
                              child: Text("Not Registered yet?",style: TextStyle(color: MyColors.color_text,fontSize:14,fontWeight: FontWeight.w400,fontFamily: "assets/fonts/poppins_regular.ttf" ),)),
                          ...
                          Align(
                            ...
                            child: GestureDetector(
                              ...
                              child: Container(
                                  ...
                                  child: Text("Create an Account",style: TextStyle(color: MyColors.color_3F84E5,fontSize:16,fontFamily: "assets/fonts/raleway/raleway_bold.ttf"),)
                              ),
                            ),
                          ),
