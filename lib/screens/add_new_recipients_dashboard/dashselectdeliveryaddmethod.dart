...
import 'package:moneytos/screens/add_new_recipients_dashboard/dashaddrecipientinfoscreen.dart';
...
class DashSelectDeliveryAddMethodScreen extends StatefulWidget {
  const DashSelectDeliveryAddMethodScreen({super.key});
  ...
  @override
  State<DashSelectDeliveryAddMethodScreen> createState() =>
      _DashSelectDeliveryAddMethodScreenState();
}

class _DashSelectDeliveryAddMethodScreenState
    extends State<DashSelectDeliveryAddMethodScreen> {
  bool load = false;
  int cureentindex = 0;
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                          builder: (_) => const SelectNewRecipientScreen(),
                        ),
                      );
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => const DashAddRecipientInfoScreen(),
                        ),
                      );
                    },
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            wSizedBox1,
                            Text(
                              accountdetaillist2.isNotEmpty
                                  ? accountdetaillist2[0]
                                      .transferMethod
                                      .toString()
                                  : '',
