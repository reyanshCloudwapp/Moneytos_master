...
class DashSelectDeliveryMethodScreen extends StatefulWidget {
  const DashSelectDeliveryMethodScreen({super.key});

  @override
  State<DashSelectDeliveryMethodScreen> createState() =>
      _DashSelectDeliveryMethodScreenState();
}

class _DashSelectDeliveryMethodScreenState
    extends State<DashSelectDeliveryMethodScreen> {
  String countryName = '';
  String countryFlag = '';
  String totalFees = '';
  String auhtToken = '';
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        const DashSelectBankScreen2BankDeposit(),
                  ),
                );
              },
              child: Container(
