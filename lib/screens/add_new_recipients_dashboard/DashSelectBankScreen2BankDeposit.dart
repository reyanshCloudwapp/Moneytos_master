...
class DashSelectBankScreen2BankDeposit extends StatefulWidget {
  ...
  @override
  State<DashSelectBankScreen2BankDeposit> createState() =>
      _DashSelectBankScreen2BankDeposit();
}

class _DashSelectBankScreen2BankDeposit
    extends State<DashSelectBankScreen2BankDeposit> {
  ///Textfield contrller
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => DashBankAccountNumber(
