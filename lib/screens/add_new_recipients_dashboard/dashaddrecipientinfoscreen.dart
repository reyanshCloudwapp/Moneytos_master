...
import 'package:moneytos/model/RecipientFiealdModel.dart';
...
class DashAddRecipientInfoScreen extends StatefulWidget {
  const DashAddRecipientInfoScreen({super.key});

  @override
  State<DashAddRecipientInfoScreen> createState() =>
      _DashAddRecipientInfoScreenState();
}

class _DashAddRecipientInfoScreenState
    extends State<DashAddRecipientInfoScreen> {
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          if (p!.getString('partnerPaymentMethod').toString() ==
                              'mfs') {
