...
class EditBankDetailsScreen extends StatefulWidget {
  final String title;
  final String last4;
  final String sec_code;
  final String rounting_number;
  ...
  const EditBankDetailsScreen({
    ...
    required this.title,
    required this.last4,
    required this.sec_code,
    required this.rounting_number,
...
class _EditBankDetailsScreenState extends State<EditBankDetailsScreen> {
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                          ...
                          //     alignment: Alignment.center,
                          //     child:
                          //     Text("a small amount will be deducted and \n refunded again for verified and linked your\n bank account",textAlign: TextAlign.center,style: TextStyle(color: MyColors.color_text.withOpacity(0.90),fontSize: 12,fontWeight: FontWeight.w500,fontFamily: "assets/fonts/raleway/Raleway-Medium.ttf"),)
                          // ),
                          // hSizedBox3,
                          hSizedBox2,
                          Container(
  ...
  Future<void> paymentmethodsRequest(
    ...
    var response = await http.post(
      Uri.parse(AllApiService.EditBankURL),
