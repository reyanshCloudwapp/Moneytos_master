...
import 'package:moneytos/screens/home/s_home/go_toreview_screen/go_toreview_screen.dart';
...
class _SelectPaymentMethodScreenState extends State<SelectPaymentMethodScreen> {
  ...
  void initState() {
    ...
    prefData();
    // debugPrint("selected payment metghod>>> " + SelectedMethod.toString());
              ...
              pushNewScreen(
                ...
                screen: GotoreviewScreen(
                  ...
                  mfsRecipientParam: MfsRecipientParam(
                    deliveryMethodType: sharedPreferences!
                        .getString('select_payment_method_status'),
                    recipientReceiveBankOrMobileNo: sharedPreferences!
                        .getString('recipientReceiveBankOrMobileNo'),
                    recipientReceiveBankNameOrOperatorName: sharedPreferences!
            ...
            children: [
              ...
              Row(
                children: [
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => EditBankDetailsScreen(
                            ...
                            last4: last4,
                            title: title,
                            rounting_number: rountingNumber,
                  ...
                  InkWell(
                    onTap: () {
                      dialogDelete(context, paymentMethodId);
                    },
  ...
  dialogDelete(BuildContext context, String paymentMethodId) {
    showDialog(
      context: context,
      builder: (_) => AlertDialog(
        shape: const RoundedRectangleBorder(
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () async {
                                  DeleteRequest(context, paymentMethodId);
