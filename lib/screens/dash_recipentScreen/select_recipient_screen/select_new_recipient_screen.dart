...
import 'package:moneytos/screens/select_recipent_contry/select_recipentCountry.dart';
...
class SelectNewRecipientScreen extends StatefulWidget {
  const SelectNewRecipientScreen({Key? key}) : super(key: key);
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  onTap: () {
                    pushNewScreen(
                      context,
                      screen: const SelectRecipentCountry(),
                      withNavBar: false,
                    );
                                                  ...
                                                  children: [
                                                    ...
                                                    Container(
                                                      alignment:
                                                          Alignment.center,
                                                      child: Text(
                                                        '${Utility.capitalizeFirstLetter(recipientList[index].firstName.toString())} ${Utility.capitalizeFirstLetter(recipientList[index].lastName.toString())}',
                                                        textAlign:
                                                            TextAlign.center,
