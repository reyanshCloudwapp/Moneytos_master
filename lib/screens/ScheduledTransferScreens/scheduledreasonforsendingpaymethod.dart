import 'package:moneytos/screens/ScheduledTransferScreens/scheduled_link_new_method.dart';
...
class ScheduledReasonForSendingPaymethod extends StatefulWidget {
  ...
  const ScheduledReasonForSendingPaymethod({
    super.key,
    required this.id,
    required this.isMfs,
  });
  ...
  @override
  State<ScheduledReasonForSendingPaymethod> createState() =>
      _ScheduledReasonForSendingPaymethodState();
}

class _ScheduledReasonForSendingPaymethodState
    extends State<ScheduledReasonForSendingPaymethod> {
  ...
  nextpage() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => ScheduledLinkNewMethodScreen(
          isMfs: widget.isMfs,
        ),
      ),
    );
