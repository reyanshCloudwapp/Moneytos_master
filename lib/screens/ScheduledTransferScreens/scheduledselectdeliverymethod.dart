...
import 'package:moneytos/screens/home/s_home/selectdeliverymethod/bankdepositselectdeliverymethod.dart';
...
class ScheduledSelectDeliveryMethodScreen extends StatefulWidget {
  const ScheduledSelectDeliveryMethodScreen({super.key});

  @override
  State<ScheduledSelectDeliveryMethodScreen> createState() =>
      _ScheduledSelectDeliveryMethodScreenState();
}

class _ScheduledSelectDeliveryMethodScreenState
    extends State<ScheduledSelectDeliveryMethodScreen> {
  String countryName = '';
  String countryFlag = '';
  String totalFees = '';
  String auhtToken = '';
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            wSizedBox1,
                            Text(countryName,style: TextStyle(fontSize: 14,fontFamily: "assets/fonts/raleway/Raleway-Medium.ttf",fontWeight: FontWeight.w500,color: MyColors.color_text),),
                          ],
                        ),
                        Container(
                            width: 50,
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        const ScheduledSelectBankScreen2BankDeposit(),
                  ),
                );
              },
              child: Container(
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const BankDepositDeliveryMethodScreen(
                      status: MyString.mobile_money,
                    ),
                  ),
                );
              },
