...
import 'package:moneytos/screens/ScheduledTransferScreens/scheduledselectdeliveryaddmethod.dart';
...
class ScheduledBankAccountNumber extends StatefulWidget {
  ...
  const ScheduledBankAccountNumber({
    Key? key,
    this.bank_name = '',
    this.bank_id = '',
  }) : super(key: key);
  ...
  static Future<void> AddBankAccountfieldFieldRequest2(
    ...
    if (response.statusCode == 201) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => const ScheduledSelectDeliveryAddMethodScreen(),
        ),
      );
    } else {
