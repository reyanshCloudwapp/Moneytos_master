import 'package:moneytos/screens/ScheduledTransferScreens/scheduledsendmoneyquatationfromNewRecipient.dart';
...
class ScheduledSelectRecipentCountry extends StatefulWidget {
  const ScheduledSelectRecipentCountry({Key? key}) : super(key: key);

  @override
  State<ScheduledSelectRecipentCountry> createState() =>
                        ...
                        return GestureDetector(
                          onTap: () async {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    const ScheduledSendMoneyQuatationFromNewRecipient(),
                              ),
                            );
