...
class ScheduledLinkNewMethodScreen extends StatefulWidget {
  ...
  @override
  State<ScheduledLinkNewMethodScreen> createState() =>
      _ScheduledLinkNewMethodScreenState();
}

class _ScheduledLinkNewMethodScreenState
    extends State<ScheduledLinkNewMethodScreen> {
  @override
                        ...
                        child: Card(
                          ...
                          child: Column(
                            children: [
                              ...
                              //         child: Row(
                              //           children: [
                              //             SvgPicture.asset("assets/icons/bank.svg",height: 36,width: 36,),
                              //             SizedBox(width: 24,),
                              //             Text(MyString.bank_acount,style: TextStyle(color:MyColors.color_text,fontSize:14,fontWeight: FontWeight.w500,fontFamily: "assets/fonts/raleway/Raleway-Medium.ttf"),),
                              //
                              //
                              //
                              //           ],
                              ...
                              //                 child: SvgPicture.asset("assets/images/mobilemoney.svg",height: 32,width: 32,)),
                              //          SizedBox(width: 24,),
                              //             Text("Mobile Money",style: TextStyle(color:MyColors.color_text,fontSize:14,fontWeight: FontWeight.w500,fontFamily: "assets/fonts/raleway/Raleway-Medium.ttf"),),
                              //
                              //           ],
                              //         ),
                              //       )),
