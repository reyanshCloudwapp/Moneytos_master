...
class TransferPinCodeScreen2 extends StatefulWidget {
  ...
  @override
  State<TransferPinCodeScreen2> createState() => _TransferPinCodeScreenState2();
}
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  wSizedBox1,
                  Container(
                    child: Text("the pin you entered is wrong",style: TextStyle(color: MyColors.whiteColor,fontFamily: "assets/fonts/raleway/Raleway-SemiBold.ttf",fontSize: 14,fontWeight: FontWeight.w600),),
                  )
                ],
              ),
            ),
