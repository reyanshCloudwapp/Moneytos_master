...
class DebitCardScreen extends StatefulWidget {
  ...
  const DebitCardScreen({super.key, required this.isMfs});
...
class _DebitCardScreenState extends State<DebitCardScreen> {
  ...
  Future<void> paymentmethodsRequest(
    ...
    if (jsonResponse['status'] == false) {
      ...
      // Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>SelectPaymentMethodScreen(selectedMethodScreen: 1,)));
      String selectedAccId = jsonResponse['id'].toString();
      String selectedAccName = jsonResponse['name'].toString();
      String selectedPaymentType =
          jsonResponse['payment_method_type'].toString();
      String selectedLast4 = jsonResponse['last4'].toString();
        ...
        screen: GotoreviewScreen(
          ...
          mfsRecipientParam: MfsRecipientParam(
            ...
            recipientReceiveBankOrMobileNo:
                sharedPreferences.getString('recipientReceiveBankOrMobileNo'),
          ...
          selected_acc_name: selectedAccName,
          selected_payment_type: selectedPaymentType,
          selected_last4: selectedLast4,
          cvv: cardCCV,
          avs_zipcode: avsZip,
