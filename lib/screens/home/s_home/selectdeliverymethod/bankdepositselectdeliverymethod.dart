...
import 'package:moneytos/screens/home/s_home/cashpickupmethodscreen/cashpickupseleclocation.dart';
import 'package:moneytos/screens/home/s_home/mobilemoneyMethod/mobilemoneynumkeyboard.dart';
import 'package:moneytos/screens/home/s_home/selectbankaccounnum/selectdeliverymethodbankaccountnumber.dart';
...
class BankDepositDeliveryMethodScreen extends StatefulWidget {
  ...
  const BankDepositDeliveryMethodScreen({
    this.status = MyString.bank_deposit,
    super.key,
  });
                            ...
                            return GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        const SelectDeliveryMethodBankAccNum(),
                                  ),
                                );
                              },
                              child: Container(
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const CashPickUpSelectLocation(),
                    ),
                  );
                },
                child: Container(
