...
class SelectDeliveryAddMethodScreen extends StatefulWidget {
  ...
  const SelectDeliveryAddMethodScreen({super.key, this.ismfsAndalready});

  @override
  State<SelectDeliveryAddMethodScreen> createState() =>
      _SelectDeliveryAddMethodScreenState();
}

class _SelectDeliveryAddMethodScreenState
    extends State<SelectDeliveryAddMethodScreen> {
...
*/
  ...
  Future<void> recipientBankAccountsapi(BuildContext context) async {
    ...
    if (jsonResponse['status'] == true) {
      ...
      if (bankListResponse.data!.isNotEmpty) {
        SharedPreferences sharedPreferences =
            await SharedPreferences.getInstance();
        ...
        data.uid = bankListResponse.data![cureentindex].uid;
        data.routingCodeType1 =
            bankListResponse.data![cureentindex].routingCodeType1;
        data.routingCodeValue1 =
            bankListResponse.data![cureentindex].routingCodeValue1;
        data.routingCodeType2 =
            bankListResponse.data![cureentindex].routingCodeType2;
        data.routingCodeValue2 =
            bankListResponse.data![cureentindex].routingCodeValue2;
        data.accountNumber = bankListResponse.data![cureentindex].accountNumber;
        data.bankAccountType =
            bankListResponse.data![cureentindex].bankAccountType;
        data.bankName = bankListResponse.data![cureentindex].bankName;
        data.bankCode = bankListResponse.data![cureentindex].bankCode;
        data.updatedAt = bankListResponse.data![cureentindex].updatedAt;
        data.createdAt = bankListResponse.data![cureentindex].createdAt;
        ...
        sharedPreferences.setString(
          'recipientReceiveBankOrMobileNo',
          bankListResponse.data![cureentindex].accountNumber.toString(),
        );
        sharedPreferences.setString(
          'recipientReceiveBankNameOrOperatorName',
          bankListResponse.data![cureentindex].bankName.toString(),
        );
      }
