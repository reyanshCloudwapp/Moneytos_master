...
class _SendMoneyQuotationFromNewRecipientState
  ...
  Future<void> loadPref() async {
    ...
    debugPrint('select paymenth method???? $select_payment_method_status');
    ...
    if ((desticountry_isoCode3 == 'NGA' &&
      ...
      destcountryCurrency_isoCode3 = 'USD';
        ...
        select_payment_method_status == 'Mobile') {
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      // Text(transfer_fees>0?"0":moneytos.toString(),style: TextStyle(color: MyColors.color_text,fontSize:12,fontFamily: "assets/fonts/raleway/Raleway-SemiBold.ttf",fontWeight: FontWeight.w800,),),
                      const Text(
                        ' USD',
                        style: TextStyle(
                          color: MyColors.color_text,
  ...
  Future<void> feesbuyapi(BuildContext context, String countryIso3) async {
    ...
    if (jsonResponse['status'] == true) {
      ...
      Is_transaction_fees_free = (widget.isMobileMoney ?? false)
      ...
      transaction_fees_free_amount_limit = (widget.isMobileMoney ?? false)
          ? double.parse(
