...
class _NotificationScreenState extends State<NotificationScreen> {
                  ...
                  children: [
                    ...
                    Transform.scale(
                      ...
                      child: CupertinoSwitch(
                        ...
                        thumbColor: app_isswitch1 == true
                            ? MyColors.lightblueColor
                            : MyColors.lightblueColor4,
                        onChanged: (bool value) {
                          setState(() {
                            app_isswitch1 = value;
                            selected_notification_status =
                                'is_app_notify_loggedin';

                            updateNotificatinsapi(
                              context,
                              selected_notification_status,
                            );
                          });
                      ...
                      child: CupertinoSwitch(
                        ...
                        onChanged: (bool value) {
                          setState(() {
                            app_isswitch2 = value;
                            selected_notification_status =
                                'is_app_notify_sales_promotions';
                            updateNotificatinsapi(
                              context,
                              selected_notification_status,
                            );
                  ...
                  children: [
                    ...
                    Transform.scale(
                      ...
                      child: CupertinoSwitch(
                        ...
                        activeColor: MyColors.lightblueColor.withOpacity(0.30),
                        trackColor: MyColors.lightblueColor.withOpacity(0.20),
                        thumbColor: email_isswitch1 == true
                            ? MyColors.lightblueColor
                            : MyColors.lightblueColor4,
                        onChanged: (bool value) {
                          setState(() {
                  ...
                  children: [
                    ...
                    Transform.scale(
                      ...
                      child: CupertinoSwitch(
                        ...
                        activeColor: MyColors.lightblueColor.withOpacity(0.30),
                        trackColor: MyColors.lightblueColor.withOpacity(0.20),
                        thumbColor: email_isswitch2 == true
                            ? MyColors.lightblueColor
                            : MyColors.lightblueColor4,
                        onChanged: (bool value) {
                          setState(() {
                            ...
                            selected_notification_status =
                                'is_email_notify_sales_promotions';
                            updateNotificatinsapi(
                              context,
                              selected_notification_status,
                            );
                  ...
                  children: [
                    ...
                    Transform.scale(
                      ...
                      child: CupertinoSwitch(
                        ...
                        activeColor: MyColors.lightblueColor.withOpacity(0.30),
                        trackColor: MyColors.lightblueColor.withOpacity(0.20),
                        thumbColor: email_isswitch3 == true
                            ? MyColors.lightblueColor
                            : MyColors.lightblueColor4,
                        onChanged: (bool value) {
                          setState(() {
                  ...
                  children: [
                    ...
                    Transform.scale(
                      ...
                      child: CupertinoSwitch(
                        ...
                        activeColor: MyColors.lightblueColor.withOpacity(0.30),
                        trackColor: MyColors.lightblueColor.withOpacity(0.20),
                        thumbColor: email_isswitch4 == true
                            ? MyColors.lightblueColor
                            : MyColors.lightblueColor4,
                        onChanged: (bool value) {
                          setState(() {
  ...
  Future<void> updateNotificatinsapi(
    ...
    var request = {};
    if (notificationStatus == 'is_app_notify_loggedin') {
      request['is_app_notify_loggedin'] = app_isswitch1 ? '1' : '0';
    } else if (notificationStatus == 'is_app_notify_sales_promotions') {
      request['is_app_notify_sales_promotions'] = app_isswitch2 ? '1' : '0';
    } else if (notificationStatus == 'is_app_notify_refferal') {
      request['is_app_notify_refferal'] = app_isswitch3 ? '1' : '0';
    } else if (notificationStatus == 'is_app_notify_txn') {
      request['is_app_notify_txn'] = app_isswitch4 ? '1' : '0';
    } else if (notificationStatus == 'is_email_notify_loggedin') {
      request['is_email_notify_loggedin'] = email_isswitch1 ? '1' : '0';
    } else if (notificationStatus == 'is_email_notify_refferal') {
      request['is_email_notify_refferal'] = email_isswitch3 ? '1' : '0';
    } else if (notificationStatus == 'is_email_notify_txn') {
      request['is_email_notify_txn'] = email_isswitch4 ? '1' : '0';
    } else if (notificationStatus == 'is_email_notify_sales_promotions') {
    ...
    var response = await http.post(
      Uri.parse(Apiservices.updateNotificatinsapi),
  ...
  Future<void> accountSettingApi(
    ...
    if (jsonResponse['status'] == true) {
      ...
      // Utility.showFlutterToast( jsonResponse['message']);
      app_isswitch1 =
          accountSettingResponse.data!.userData!.isAppNotifyLoggedin == '1'
              ? true
              : false;
      app_isswitch2 =
          accountSettingResponse.data!.userData!.isAppNotifySalesPromotions == 1
              ? true
              : false;
      app_isswitch3 =
          accountSettingResponse.data!.userData!.isAppNotifyRefferal == '1'
              ? true
              : false;
      app_isswitch4 =
          accountSettingResponse.data!.userData!.isAppNotifyTxn == '1'
              ? true
              : false;

      email_isswitch1 =
          accountSettingResponse.data!.userData!.isEmailNotifyLoggedin == '1'
              ? true
              : false;
      email_isswitch2 =
          accountSettingResponse.data!.userData!.isEmailNotifySalesPromotions ==
                  1
              ? true
              : false;
      email_isswitch3 =
          accountSettingResponse.data!.userData!.isEmailNotifyRefferal == '1'
              ? true
              : false;
      email_isswitch4 =
          accountSettingResponse.data!.userData!.isEmailNotifyTxn == '1'
              ? true
              : false;
