...
class ManageSelectPaymentMethodScreen extends StatefulWidget {
  ...
  const ManageSelectPaymentMethodScreen({
    Key? key,
    required this.selectedMethodScreen,
  }) : super(key: key);

  @override
  State<ManageSelectPaymentMethodScreen> createState() =>
      _ManageSelectPaymentMethodScreenState();
}

class _ManageSelectPaymentMethodScreenState
    extends State<ManageSelectPaymentMethodScreen> {
  bool _enabled = true;
                                  ...
                                  child: Material(
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          children: [
                                            SvgPicture.asset(
                                              "assets/icons/bank.svg",height: 30,width: 30, color:SelectedMethod==0?MyColors.lightblueColor:MyColors.blackColor ,),
                                            hSizedBox1,
                                            hSizedBox,
                                            Container(
                                              alignment: Alignment.center,
                            ...
                            children: [
                              ...
                              GestureDetector(
                                ...
                                onTap: () {
                                  ...
                                  pushNewScreen(
                                    context,
                                    screen: ManagePaymentBankDetailsScreen(
                                      oncallBack: Update,
                                    ),
                                    withNavBar: false,
                                  );
                            ...
                            children: [
                              ...
                              GestureDetector(
                                ...
                                onTap: () {
                                  ...
                                  pushNewScreen(
                                    context,
                                    screen: ManagePaymentDebitCardScreen(
                                      oncallBack: Update,
                                    ),
                                    withNavBar: false,
                                  );
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          onTap: () {
                            ...
                            pushNewScreen(
                              context,
                              screen: const SelectServiceProviderScreen(
                                isMfs: false,
                              ),
                              withNavBar: false,
                            );
