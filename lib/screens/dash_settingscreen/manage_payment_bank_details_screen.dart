...
class ManagePaymentBankDetailsScreen extends StatefulWidget {
  ...
  const ManagePaymentBankDetailsScreen({Key? key, required this.oncallBack})
      : super(key: key);

  @override
  State<ManagePaymentBankDetailsScreen> createState() =>
      _ManagePaymentBankDetailsScreenState();
}

class _ManagePaymentBankDetailsScreenState
    extends State<ManagePaymentBankDetailsScreen> {
