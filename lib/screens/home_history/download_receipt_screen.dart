...
class _DownloadReceiptScreenState extends State<DownloadReceiptScreen> {
  ...
  Future<void> mainpdfave() async {
    var assetImage = pw.MemoryImage(
      (await rootBundle.load('assets/icons/bankpng.png')).buffer.asUint8List(),
    );

    var assetImageBank = pw.MemoryImage(
      (await rootBundle.load('assets/icons/bank4png.png')).buffer.asUint8List(),
    );

    var assetImageexc = pw.MemoryImage(
      (await rootBundle.load('assets/icons/small_swappng.png'))
          .buffer
          .asUint8List(),
    );
      ...
      pw.MultiPage(
        ...
        build: (pw.Context context) => <pw.Widget>[
          pw.Container(
            ...
            child: pw.Container(
              padding:
                  const pw.EdgeInsets.symmetric(horizontal: 0, vertical: 20),
                    ...
                    children: [
                      pw.ClipRRect(
                        ...
                        child: pw.Container(
                          ...
                          child: pw.Text(
                            first_name.toString()[0].toUpperCase(),
                      ...
                      transform: new Matrix4.identity()
                        ...
                        pw.Container(
                          child: pw.Row(
                            children: [
                              // SvgPicture.asset(
                              //   "assets/icons/bank.svg",color: MyColors.blackColor,
                              // ),
                              pw.Container(
                                width: 36,
                                height: 36,
                                child: pw.Image(assetImageBank),
                              ),
                              pw.SizedBox(width: 10),
                              pw.Column(
                                crossAxisAlignment: pw.CrossAxisAlignment.start,
              ...
              children: [
                ...
                pw.Container(
                  ...
                  child: pw.Text(
                    created_at == ''
                        ? ''
                        : Utility.DatefomatToDateTime(created_at),
                    // style: TextStyle(
                    //     letterSpacing: 0.5,
                    //     color: MyColors.blackColor,
                    //     fontSize: 12,
          ...
          pw.Container(
            ...
            padding: const pw.EdgeInsets.symmetric(horizontal: 20),
            child: pw.Text(
              MyString.consumer_fraud_alert_des,
              // style: TextStyle(
              //     fontSize: 12,
              //     fontWeight: FontWeight.w500,
              //     fontFamily:
          ...
          pw.Container(
            ...
            padding: const pw.EdgeInsets.symmetric(horizontal: 20),
            child: pw.Text(
              MyString.consumer_fraud_alert_des1,
              // style: TextStyle(
              //     fontSize: 12,
              //     fontWeight: FontWeight.w500,
              //     fontFamily:
          ...
          pw.Container(
            ...
            padding: const pw.EdgeInsets.symmetric(horizontal: 20),
            child: pw.Text(
              MyString.minnesota_dept_of_commerce,
              // style: TextStyle(
              //     fontSize: 16,
              //     fontWeight: FontWeight.w500,
              //     fontFamily: "assets/fonts/raleway/Raleway-Bold.ttf",
          ...
          pw.Container(
            ...
            padding: const pw.EdgeInsets.symmetric(horizontal: 20),
            child: pw.Text(
              MyString.minnesota_dept_of_commerce_des1,
              // style: TextStyle(
              //     fontSize: 12,
              //     fontWeight: FontWeight.w500,
              //     fontFamily:
          ...
          pw.Container(
            ...
            padding: const pw.EdgeInsets.symmetric(horizontal: 20),
            child: pw.Text(
              MyString.minnesota_dept_of_commerce_des2,
              // style: TextStyle(
              //     fontSize: 12,
              //     fontWeight: FontWeight.w500,
              //     fontFamily:
          ...
          pw.Container(
            ...
            padding: const pw.EdgeInsets.symmetric(horizontal: 20),
            child: pw.Text(
              MyString.minnesota_dept_of_commerce_des3,
              // style: TextStyle(
              //     fontSize: 12,
              //     fontWeight: FontWeight.w500,
              //     fontFamily:
          ...
          pw.Container(
            ...
            padding: const pw.EdgeInsets.symmetric(horizontal: 20),
            child: pw.Text(
              MyString.minnesota_dept_of_commerce_des4,
              // style: TextStyle(
              //     fontSize: 12,
              //     fontWeight: FontWeight.w500,
              //     fontFamily:
          ...
          pw.Container(
            ...
            padding: const pw.EdgeInsets.symmetric(horizontal: 20),
            child: pw.Text(
              MyString.minnesota_dept_of_commerce_des5,
              // style: TextStyle(
              //     fontSize: 12,
              //     fontWeight: FontWeight.w500,
              //     fontFamily:
          ...
          pw.Container(
            ...
            padding: const pw.EdgeInsets.symmetric(horizontal: 20),
            child: pw.Text(
              MyString.minnesota_dept_of_commerce_des6,
              // style: TextStyle(
              //     fontSize: 12,
              //     fontWeight: FontWeight.w500,
              //     fontFamily:
          ...
          pw.Container(
            ...
            padding: const pw.EdgeInsets.symmetric(horizontal: 20),
            child: pw.Text(
              MyString.minnesota_dept_of_commerce_des7,
              // style: pw.TextStyle(
              //     fontSize: 12,
              //     fontWeight: FontWeight.w500,
              //     fontFamily:
          ...
          pw.Container(
            ...
            padding: const pw.EdgeInsets.symmetric(horizontal: 20),
            child: pw.Text(
              MyString.consumer_Financial_Protection_Bureau,
              style: const pw.TextStyle(fontSize: 16, letterSpacing: 0.7),
            ),
          ),
          pw.SizedBox(height: 10),
          pw.Container(
          ...
          /* hSizedBox2,
                          ...
                          Container(
                            ...
                            child: Text(MyString.consumer_Financial_Protection_Bureau,
                                style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500,fontFamily: "assets/fonts/raleway/Raleway-Bold.ttf",color: MyColors.blackColor,letterSpacing: 0.7)),
                          ),
                          hSizedBox1,
                          Container(
                            alignment: Alignment.topLeft,
                            ...
                            child: Text(MyString.consumer_Financial_Protection_Bureau_des,
                                style: TextStyle(fontSize: 12,fontWeight: FontWeight.w500,fontFamily: "assets/fonts/montserrat/MontserratAlternates-Medium.otf",color: MyColors.blackColor.withOpacity(0.70),letterSpacing: 0.7)),
                          ),
*/
    ...
    final dirPathnew = await Directory(dirPath).create();
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              MyString
                                  .consumer_Financial_Protection_Bureau_des1,
                              style: TextStyle(
                                fontSize: 12,
                                fontWeight: FontWeight.w500,
                                fontFamily:
...
*/
  ...
  Future<void> txnDetailapi(BuildContext context) async {
    ...
    var response = await http.get(
      Uri.parse('${Apiservices.txnDetailapi}?txn_id=${widget.txnId}'),
  ...
  Future<void> TransfersApi(
    ...
    if (response.statusCode == 200) {
      ...
      total_amount =
          (double.parse(you_send) + double.parse(widget.fees)).toString();
      total_amount = double.parse(double.parse(total_amount).toStringAsFixed(2))
          .toString();
