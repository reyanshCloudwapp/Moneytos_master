...
import 'package:moneytos/screens/dash_settingscreen/dash_settingScreen.dart';
import 'package:moneytos/screens/home/home.dart';
...
class DashboardScreen extends StatefulWidget {
  final int currentpage_index;
  final bool islogout;

  const DashboardScreen({
    Key? key,
    this.currentpage_index = 0,
    this.islogout = false,
  }) : super(key: key);
            ...
            child:
              ...
              onItemSelected: (int index) {
                setState(() {
                  ...
                  debugPrint('pageindex...$pageindex$islogout');
                }); // This is required to update the nav bar if Android back button is pressed
              },
  ...
  final List<PersistentBottomNavBarItem> _bottomNavList = [
    PersistentBottomNavBarItem(
      ...
      icon: SvgPicture.asset(
        'assets/icons/home_blue_icon.svg',
        // height: 30,
        // width: 30,
    ...
    PersistentBottomNavBarItem(
      icon: SvgPicture.asset(
        'assets/icons/bottombar_icon/graph.svg',
        // height: 20,
        // width: 20,
        color: MyColors.lightblueColor,
      ),
    ...
    PersistentBottomNavBarItem(
      icon: SvgPicture.asset(
        'assets/icons/bottombar_icon/bold_user.svg',
        height: 20,
        width: 20,
        color: MyColors.color_3F84E5,
      ),
    ...
    PersistentBottomNavBarItem(
      icon: SvgPicture.asset(
        'assets/icons/bottombar_icon/setting.svg',
        height: 20,
        width: 20,
        color: MyColors.color_3F84E5,
      ),
        ...
        icon: Padding(
          ...
          child: Transform.scale(
            ...
            child: pageindex == 0
                ...
                : SvgPicture.asset(
                    'assets/icons/home_grey_icon.svg', /*height: 20, width: 20*/
                  ),
          ),
        ),
        title: (MyString.home),
        ...
        icon: Padding(
          ...
          child: Transform.scale(
            ...
            child: Container(
              ...
              child: pageindex == 1
                  ? SvgPicture.asset(
                      'assets/icons/history_blue_icon.svg',
                      height: 20,
                      width: 20,
                      // color: MyColors.lightblueColor,
                    )
                  : SvgPicture.asset(
                      'assets/icons/history_grey_icon.svg',
                      height: 20,
                      width: 20,
                    ),
            ),
        ...
        icon: Padding(
          ...
          child: Transform.scale(
            ...
            child: Container(
              ...
              child: pageindex == 2
                  ? SvgPicture.asset(
                      'assets/icons/recipients_blue_icon.svg',
                      height: 20,
                      width: 20,
                    )
                  : SvgPicture.asset(
                      'assets/icons/recipients_grey_icon.svg',
                      height: 20,
                      width: 20,
                    ),
            ),
        ...
        icon: Padding(
          ...
          child: Transform.scale(
            ...
            child: Container(
              ...
              child: pageindex == 3
                  ? SvgPicture.asset(
                      'assets/icons/setting_blue_icon.svg',
                      height: 20,
                      width: 20,
                    )
                  : SvgPicture.asset(
                      'assets/icons/setting_grey_icon.svg',
                      height: 20,
                      width: 20,
                    ),
            ),
...
/*  appBar: PreferredSize(
   ...
   List<PersistentBottomNavBarItem> _navBarsItems() {
     return [
       PersistentBottomNavBarItem(
         contentPadding: 0.1,
         icon: pageindex == 0 ? SvgPicture.asset("assets/icons/bottombar_icon/home.svg",height: 20,width: 20,color: MyColors.lightblueColor,)
             :SvgPicture.asset("assets/icons/bottombar_icon/bold_home.svg",height: 20,width: 20),
       ...
       PersistentBottomNavBarItem(
         icon:  pageindex == 1 ?
         SvgPicture.asset("assets/icons/bottombar_icon/graph.svg",height: 20,width: 20, color: MyColors.lightblueColor, )
             :
         SvgPicture.asset("assets/icons/bottombar_icon/light_graph.svg",height: 20,width: 20,  ),
         title: (MyString.chart),
         textStyle: TextStyle(color: MyColors.color_3F84E5,fontWeight: FontWeight.w600,fontSize: 14),
         activeColorPrimary: MyColors.color_3F84E5,
         inactiveColorPrimary: CupertinoColors.systemGrey,
       ...
       PersistentBottomNavBarItem(
         icon:  pageindex == 2 ? SvgPicture.asset("assets/icons/bottombar_icon/bold_user.svg",height: 20,width: 20, color: MyColors.color_3F84E5   )
             :
         SvgPicture.asset("assets/icons/bottombar_icon/light_user.svg",height: 20,width: 20,  ),
         title: (MyString.recipients),
         textStyle: TextStyle(color: MyColors.color_3F84E5,fontWeight: FontWeight.w600,fontSize: 14),
         activeColorPrimary: MyColors.color_3F84E5,
         inactiveColorPrimary: CupertinoColors.systemGrey,
       ...
       PersistentBottomNavBarItem(
         icon:  pageindex == 3 ? SvgPicture.asset("assets/icons/bottombar_icon/setting.svg",height: 20,width: 20, color: MyColors.color_3F84E5 )
             :
         SvgPicture.asset("assets/icons/bottombar_icon/light_setting.svg",height: 20,width: 20,  ),
         title: (MyString.setting),
         textStyle: TextStyle(color: MyColors.color_3F84E5,fontWeight: FontWeight.w600,fontSize: 13.80,fontFamily: "assets/fonts/raleway/raleway_bold.ttf"),
         activeColorPrimary: MyColors.color_3F84E5,
         inactiveColorPrimary: CupertinoColors.systemGrey,
       ),
     ];
