...
class DashSelectBankScreen2BankDeposit extends StatefulWidget {
  const DashSelectBankScreen2BankDeposit({Key? key}) : super(key: key);

  @override
  State<DashSelectBankScreen2BankDeposit> createState() => _DashSelectBankScreen2BankDeposit();
}

class _DashSelectBankScreen2BankDeposit extends State<DashSelectBankScreen2BankDeposit> {
  ///Textfield contrller
            ...
            GridView(
              ...
              children:List.generate(selectbankposts.length, (index) {
                return GestureDetector(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>DashBankAccountNumber(bank_name:  selectbankposts[index].name.toString(),bank_id:selectbankposts[index].id.toString())));
                  },
                  child: Container(
