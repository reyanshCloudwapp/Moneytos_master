...
class RecipientDetailSelectBankScreen extends StatefulWidget {
  Function onCallback;
  RecipientDetailSelectBankScreen({Key? key,required this.onCallback}) : super(key: key);

  @override
  State<RecipientDetailSelectBankScreen> createState() => _RecipientDetailSelectBankScreen();
}

class _RecipientDetailSelectBankScreen extends State<RecipientDetailSelectBankScreen> {
  ///Textfield contrller
              ...
              children:List.generate(selectbankposts.length, (index) {
                return GestureDetector(
                  onTap: (){
                    pushNewScreen(
                      context,
                      screen: RecipientDetailBankAccountNumber(bank_name:  selectbankposts[index].name.toString(),bank_id:selectbankposts[index].id.toString(), Oncallback: Update,),
                      withNavBar: false,
                    );
