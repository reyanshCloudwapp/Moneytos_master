...
import 'package:moneytos/add_new_recipients_dashboard/recipient_detail_bank_accountNumber.dart';
...
import 'dash_bank_accountNumber.dart';
import 'edit_bank_accountNumber.dart';

class EditSelectBankScreen extends StatefulWidget {
  Function onCallback;
  String recipient_account_id;
  EditSelectBankScreen({Key? key,required this.onCallback,required this.recipient_account_id}) : super(key: key);

  @override
  State<EditSelectBankScreen> createState() => _EditSelectBankScreen();
}

class _EditSelectBankScreen extends State<EditSelectBankScreen> {
  ///Textfield contrller
              ...
              children:List.generate(selectbankposts.length, (index) {
                return GestureDetector(
                  onTap: (){
                    pushNewScreen(
                      context,
                      screen: EditBankAccountNumber(bank_name:  selectbankposts[index].name.toString(),bank_id:selectbankposts[index].id.toString(),recipient_account_id:widget.recipient_account_id, Oncallback: Update,),
                      withNavBar: false,
                    );
