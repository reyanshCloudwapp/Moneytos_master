...
class RecipientDetailBankAccountNumber extends StatefulWidget {
  ...
  RecipientDetailBankAccountNumber({Key? key, this.bank_name = "", this.bank_id = "",required this.Oncallback}) : super(key: key);

  @override
  State<RecipientDetailBankAccountNumber> createState() => _RecipientDetailBankAccountNumberState();
}

class _RecipientDetailBankAccountNumberState extends State<RecipientDetailBankAccountNumber> {
...
*/
  ...
  Future <void> niumRoutingCodeTypesApi(BuildContext context,) async {
    ...
    for(var dataval in jsonResponse['data']){
      ...
      niumroutingcodetypeList.add(NiumRoutingCodeType(type: dataval['routing_code_type'].toString(),validation: dataval['validate_expressions'].toString(),accountnumbervalidation: dataval['account_number_validate'].toString(),value: ""));
    }
