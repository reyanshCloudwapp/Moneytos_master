...
class DashSelectRecipentCountry extends StatefulWidget {
   DashSelectRecipentCountry({Key? key}) : super(key: key);

  @override
  State<DashSelectRecipentCountry> createState() => _DashSelectRecipentCountryScreenState();
}


class _DashSelectRecipentCountryScreenState extends State<DashSelectRecipentCountry> {
                    ...
                    child: GestureDetector(
                      onTap: () async {
                       ...
                       // Navigator.push(context, MaterialPageRoute(builder: (context)=>DashSelectDeliveryMethodScreen()));
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>DashAddRecipientInfoScreen()));
                       ...
                       sharedPreferences.setString("phonenumber_min_max_validation",selectCountryList[index].phonumberMinMaxValidation.toString());
                        sharedPreferences.setString("partnerPaymentMethod", selectCountryList[index].partnerPaymentMethod.toString());
