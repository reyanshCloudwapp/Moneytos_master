          ...
          flexibleSpace: Container(
            ...
            child: Column(
              children: [
                Container(
                  alignment: Alignment.center,
                  child: const Text(MyString.Select_Recipient_City,style: TextStyle(color: MyColors.color_text,fontSize: 18,fontWeight: FontWeight.w600,letterSpacing: 0.4,fontFamily: "s_asset/font/raleway/raleway_semibold.ttf"),),
                ),
                hSizedBox4,
                Container(
                      ...
                      children:CustomList.countrylist.map((String url) {
                        return GestureDetector(
                          ...
                          child: Container(
                              ...
                              child: const Center(child: Text(MyString.city_name,style: TextStyle(color:MyColors.color_text,fontSize:14,fontWeight: FontWeight.w500,fontFamily: "s_asset/font/raleway/raleway_medium.ttf"),))),
                        );
                      }).toList(),
                    ),
                    hSizedBox5,
