...
class EditDebitCardScreen extends StatefulWidget{
  String avsAddress;
  String avsZip;
  String title;
  String CardNumber;
  ...
  Function oncallBack;
  EditDebitCardScreen({super.key, required this.avsAddress, required this.avsZip, required this.title, required this.CardNumber, required this.Month, required this.Year, required this.payment_method_id, required this.oncallBack});
  @override
  State<EditDebitCardScreen> createState() => _EditDebitCardScreenState();
}

class _EditDebitCardScreenState extends State<EditDebitCardScreen> {
  ...
  void Dataset(){
    ...
    holdernameController.text = widget.title;
    cardnumberController.text = widget.CardNumber;
    dateController.text = widget.Month.length>9?widget.Month:"0"+widget.Month+"/"+widget.Year;
    // ccvController.text = widget.title;
    addressController.text = widget.avsAddress;
    zipController.text = widget.avsZip;
  }
  @override
  ...
  Future<void> paymentmethodsRequest(BuildContext context,String avs_address,String avs_zip,String name,int expiry_month,int expiry_year,String card,String cardCCV) async {
    ...
    request['payment_method_id'] = widget.payment_method_id;
    request['name'] = name;
    ...
    var response = await http.post(Uri.parse(AllApiService.EditDebitCardURL),
