...
class _BankDetailsScreenState extends State<BankDetailsScreen> {
                              ...
                              onTap: (){
                                ...
                                // }
                                  ...
                                  print("Enter Api Calling >>>>> ");
                                   paymentmethodsRequest(context, name, routing_number, "PPD", account_number);
                                }
  ...
  Future<void> paymentmethodsRequest(BuildContext context,String name,String routing_number,String sec_code,String account_number) async {
    ...
    if(response.statusCode==200){
      ...
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>SelectPaymentMethodScreen(isMfs: false,selectedMethodScreen: 0,)));
    }else{
      CustomLoader.ProgressloadingDialog(context, false);
      Map<String, dynamic> jsonResponse = convert.jsonDecode(response.body);
