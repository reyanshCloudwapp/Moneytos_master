...
class ReasonForSendingPaymethod extends StatefulWidget{
  String id;
  ReasonForSendingPaymethod({super.key, required this.id});
  @override
  State<ReasonForSendingPaymethod> createState() => _ReasonForSendingPaymethodState();
}
...
class _ReasonForSendingPaymethodState extends State<ReasonForSendingPaymethod> {
  ...
  nextpage(){
    Navigator.push(context, MaterialPageRoute(builder: (context)=>LinkNewMethodScreen()));
  }
