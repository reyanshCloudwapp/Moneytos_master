...
class MobileMoneypinServicePro extends StatefulWidget {
  final bool isMfs;

  const MobileMoneypinServicePro({super.key, required this.isMfs});
  @override
  State<MobileMoneypinServicePro> createState() =>
      _MobileMoneypinServiceProState();
}

class _MobileMoneypinServiceProState extends State<MobileMoneypinServicePro> {
      ...
      child: Container(
          ...
          child: Center(
            ...
            style: const TextStyle(
                ...
                fontSize: 18,
                fontFamily: "s_asset/font/raleway/Bold.ttf"),
          ))),
    );
  }
}
