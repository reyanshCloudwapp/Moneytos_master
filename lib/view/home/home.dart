...
class _HomeScreenState extends State<HomeScreen> {
  ...
  prefData() async {
    ...
    print("doucument_status>>> $state_verified");
    ...
    if (jsonResponse['status'] == true) {
      ...
      for (var commondata in commonsettinglistResponse.data!.commonData!) {
        ...
        if (commondata.slugName == "site_schedule_status") {
          print("slug value>>>  ${commondata.slugValue}");
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            SvgPicture.asset(
                                              "a_assets/icons/notificationblue.svg",
                                              height: 30,
                                              width: 30,
                                            ),
                                            const SizedBox(
                              ...
                              return RichText(
                                text: TextSpan(
                                  children: <InlineSpan>[
                                    WidgetSpan(
                                      child: SvgPicture.asset(
                                        'a_assets/images/coin.svg', // Replace with the path to your SVG image asset
                                      ),
                                    ),
                                    const WidgetSpan(
                                      child: SizedBox(
                                                    ...
                                                    children: [
                                                      Text(
                                                        ...
                                                        style: const TextStyle(
                                                            ...
                                                            fontSize: 14,
                                                            fontFamily:
                                                                "s_asset/font/circularstd/circular_std_medium.ttf"),
                                                      ),
                                                      const SizedBox(
                                                        height: 4,
                                                      ),
                                ...
                                Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        borderRadius: const BorderRadius.all(
                                            Radius.circular(20))),
                                    child: SvgPicture.asset(
                                        "a_assets/images/calendar_2.svg"))
                              ],
                            ),
                          ),
                        ),
                              ...
                              Positioned(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    const Spacer(),
                                    SvgPicture.asset(
                                        "a_assets/images/arrow_up_right.svg"),
                                  ],
                                ),
                              ),
                            ],
  ...
  Future<void> createcustomersRequest(BuildContext context) async {
    ...
    if (response.statusCode == 201) {
      Map<String, dynamic> jsonResponse = convert.jsonDecode(response.body);
      print("jsonResponse>>> if$jsonResponse");
      print("magig pay id>>> if${jsonResponse["id"]}");
      ...
      Map<String, dynamic> jsonResponse = convert.jsonDecode(response.body);
      print("jsonResponse>>> else$jsonResponse");
  ...
  Future<void> addMagicpayCustomerIdapi(
      BuildContext context, String magicpay_customer_id) async {
    ...
    Map<String, dynamic> jsonResponse = convert.jsonDecode(response.body);
    print("createMagicpayTxnapi>>>> $jsonResponse");
    if (jsonResponse['status'] == true) {
  ...
  Future<void> getTokenApi(
    ...
    print("token_auhtToken>>>>>>>>${jsonResponse['token']}");
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
  ...
  Future<void> homeExchangeRateApi(
    ...
    var response = await http.get(Uri.parse(AllApiService.homeExchangeRateURL),
        // body: convert.jsonEncode(request),
        headers: {
          "X-AUTHTOKEN": "${sharedPreferences.getString("auth")}",
          "X-USERID": "${sharedPreferences.getString("userid")}",
    ...
    if (jsonResponse['status'] == true) {
      HomeExchangerateResponse homeExchangerateResponse =
          await HomeExchangerateResponse.fromJson(jsonResponse);
  ...
  Future<void> scheduleTransferListapi(BuildContext context) async {
    ...
    var response =
        await http.get(Uri.parse(Apiservices.scheduleTransferListapi),
            // body: convert.jsonEncode(request),
            headers: {
          "X-AUTHTOKEN": "${p.getString("auth")}",
          "X-USERID": "${p.getString("userid")}",
    ...
    if (jsonResponse['status'] == true) {
      ScheduleTransferResponse scheduleTransferResponse =
          await ScheduleTransferResponse.fromJson(jsonResponse);
      schedule_count =
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  prefData() async {
    ...
    state_verified = sharedPreferences.getBool("state_verified")!;
    site_schedule_status = sharedPreferences.getString("site_schedule_status")!;
    print("doucument_status>>> "+state_verified.toString());
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: AssetImage("a_assets/images/map.png"),
                          fit: BoxFit.cover)),
                ),
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      SvgPicture.asset(
                                        "a_assets/icons/hm_notification.svg",
                                        height: 30,
                                        width: 30,
                                      ),
                                  ...
                                  AllApiService.isNotification == ""?
                                      Container():
                                      SvgPicture.asset(
                                        "a_assets/icons/hm_notification_badge.svg",
                                        height: 14,
                                        width: 14,
                                      ),
                                    ],
  ...
  Future <void> getTokenApi(BuildContext context,) async {
    ...
    Map<String, dynamic> jsonResponse = convert.jsonDecode(response.body);
    // getTokenResponse  = await GetTokenResponse.fromJson(jsonResponse);
    print("token_auhtToken>>>>>>>>"+jsonResponse['token'].toString());
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    sharedPreferences.setString("auth_Token",jsonResponse['token'].toString());
    // is_load = false;
    // CustomLoader.ProgressloadingDialog6(context, false);
