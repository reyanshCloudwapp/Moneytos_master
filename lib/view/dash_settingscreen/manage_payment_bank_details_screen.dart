...
class ManagePaymentBankDetailsScreen extends StatefulWidget{
  Function oncallBack;
  ManagePaymentBankDetailsScreen({Key? key,required this.oncallBack}) : super(key: key);
  @override
  State<ManagePaymentBankDetailsScreen> createState() => _ManagePaymentBankDetailsScreenState();
}

class _ManagePaymentBankDetailsScreenState extends State<ManagePaymentBankDetailsScreen> {
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: (){
                                ...
                                String routing_number = routingnumberController.text.trim();
                                // String sec_code = seccodeController.text.trim();
                                String sec_code = "PPD";
                                String account_number = accountnumberController.text.trim();
                                if(name.isEmpty){
                                  ...
                                  print("Enter Api Calling >>>>> ");
                                   paymentmethodsRequest(context, name, routing_number, sec_code, account_number);
                                }
                              ...
                              child: Container(
                                  ...
                                  margin: const EdgeInsets.only(left: 90, right: 90, bottom: 0,top: 20.0),
                                  child: const Text("Link Bank Account",textAlign: TextAlign.center,style: TextStyle(color: MyColors.whiteColor,fontWeight:FontWeight.w600,fontSize:18,fontFamily: "s_asset/font/raleway/raleway_bold.ttf"),)
                              ),
                            ),
                            hSizedBox2,
                            Container(
  ...
  Future<void> paymentmethodsRequest(BuildContext context,String name,String routing_number,String sec_code,String account_number) async {
    ...
    var response = await http.post(Uri.parse(AllApiService.AddMagicSenderBank),
