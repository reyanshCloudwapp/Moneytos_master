...
class ManagePaymentDebitCardScreen extends StatefulWidget{
  Function oncallBack;
  ManagePaymentDebitCardScreen({Key? key,required this.oncallBack}) : super(key: key);
  @override
  State<ManagePaymentDebitCardScreen> createState() => _ManagePaymentDebitCardScreenState();
}

class _ManagePaymentDebitCardScreenState extends State<ManagePaymentDebitCardScreen> {
