...
import 'package:moneytos/view/dash_settingscreen/about_us.dart';
import 'package:moneytos/view/dash_settingscreen/help_center_screen/help_center_screen.dart';
import 'package:moneytos/view/dash_settingscreen/legalResorcesScreen.dart';
import 'package:moneytos/view/dash_settingscreen/manage_payment_method/menage_payment_methodScreen.dart';
import 'package:moneytos/view/dash_settingscreen/setting_account_setting/dash_setting_languageScreen/dash_setting_languageScreen.dart';
import 'package:moneytos/view/dash_settingscreen/setting_account_setting/notification/notification_screen.dart';
import 'package:moneytos/view/dash_settingscreen/setting_account_setting/setting_account_setting.dart';
import 'package:moneytos/view/dash_settingscreen/setting_changePass/setting_changePassword.dart';
import 'package:moneytos/view/dash_settingscreen/setting_vaerification_screen.dart';
...
import 'package:moneytos/view/selectstorescreen/selectstorescreen.dart';
...
import 'refer_a_friendScreen/refer_a_friendScreen.dart';
import 'dart:convert' as convert;

class Setting_home extends StatefulWidget {
  bool islogout = false;

  Setting_home({Key? key,this.islogout = false}) : super(key: key);

  @override
  _Setting_homeState createState() => _Setting_homeState();
}
 ...
 /* @override
  ...
  Widget build(BuildContext context) {
    ...
    return MediaQuery(
        ...
        child: Scaffold(
          ...
          body: Stack(
            children: [
              Container(height: 350,color: MyColors.light_primarycolor2,),
              Container(
                                 ...
                                 /*   documentdetaillist.length > 0 ?   documentdetaillist[0].approvedBy == "1" ?
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: [
                                        SvgPicture.asset(
                                          "s_asset/images/verification.svg",
                                          color: MyColors.blackColor,
                                          width: 20,
                                          height: 20,
                                        ),
                                ...
                                InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: [
                                        SvgPicture.asset(
                                          "s_asset/images/Notification.svg",
                                          color: MyColors.blackColor,
                                          width: 20,
                                          height: 20,
                                        ),
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      SvgPicture.asset(
                                        "s_asset/images/enablefaceid.svg",
                                        color: MyColors.blackColor,
                                        width: 20,
                                        height: 20,
                                      ),
                                ...
                                GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: [
                                        SvgPicture.asset(
                                          "s_asset/images/legalresource.svg",
                                          color: MyColors.blackColor,
                                          width: 20,
                                        ),
                                        Container(
              ...
              widget.islogout == true ? GestureDetector(
                onTap: (){
                  setState(() {
                    widget.islogout = false;
                  });
      ...
      builder: (BuildContext context) {
        return Container(
          height: MediaQuery.of(context).size.height * 0.8,
            ...
            child: SetupNewPinCodeScreen(Oncallback: Update,));
      },
    );
  }
  Future<void> FaceEnableDisableRequest(BuildContext context,
      ) async {
    ...
    var response = await http.post(Uri.parse(AllApiService.isFaceEnableDisableURL),
  ...
  Future<void> paymentmethodsRequest(BuildContext context) async {
    ...
    if(response.statusCode==200){
      ...
      print("viewdebitcardlist.length.length>>> "+viewdebitcardlist.length.toString());
      viewdebitcardlist.length>=0?pushNewScreen(
          context,
          screen: ManageSelectPaymentMethodScreen(selectedMethodScreen: 0,),
    withNavBar: false,
    ):
      pushNewScreen(
        context,
  ...
  Future<void> disablepinRequest(BuildContext context
      ) async {
    // CustomLoader.ProgressloadingDialog(context, true);
    SharedPreferences p = await SharedPreferences.getInstance();
    var request = {};
    ...
    var response = await http.post(Uri.parse(AllApiService.updateNotificatinsURL),
        body: convert.jsonEncode(request),
        headers: {
          "X-AUTHTOKEN": "${p.getString("auth")}",
          "X-USERID": "${p.getString("userid")}",
