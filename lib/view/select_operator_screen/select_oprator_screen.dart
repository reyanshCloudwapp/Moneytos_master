...
class SelectOperatorScreen extends StatefulWidget {
  ...
  final bool? moreAdd;
  Function? Oncallback;
  SelectOperatorScreen({super.key,this.isAlreadyRecipient=false,this.moreAdd=false,this.Oncallback});
...
/*  Oncallback(bool load){
  ...
  addRecipientField() async {
    ...
    await Webservices.AddRecipientFieldRequest(
        context, addfieldlist, frontimg.toString());
    // setState(() {
    //   field_load = false;
    // });
    setState(() {});
              ...
              children: [
                ...
                Visibility(
                  ...
                  child: GridView(
                    ...
                    children: List.generate(mobileOperatorList.length, (index) {
  ...
  Future<void> getOperatorListApi(
    ...
    var iso2 = await sharedPreferences.getString("iso2");
  ...
  onNextTap(BuildContext context) async {
    if (selectedIndex < 0) {
      ...
      sharedPreferences.setString("recipientReceiveBankNameOrOperatorName", mobileOperatorList[selectedIndex].mobileOperatorOperator.toString());
      sharedPreferences.setString("juba_NominatedCode", mobileOperatorList[selectedIndex].jubaNominatedCode.toString());
      (widget.moreAdd??false)?
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) =>
          AddRecipientMobileScreen(
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          ...
          p!.getString("select_payment_method_status").toString()=="Mobile"?
