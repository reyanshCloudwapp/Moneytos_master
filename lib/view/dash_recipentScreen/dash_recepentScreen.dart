...
class RecipentScreen extends StatefulWidget {
  ...
  RecipentScreen({Key? key, required this.backToHome}) : super(key: key);
...
class _RecipentScreenState extends State<RecipentScreen> {
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          SvgPicture.asset("a_assets/images/add_user_new.svg"),
                          const SizedBox(
                            width: 5,
                          ),
              ...
              Row(
                children: [
                    ...
                    child: Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon: IconButton(onPressed: () {  }, icon: SvgPicture.asset("a_assets/images/ic_search_new.svg"),iconSize: 20),
                          ...
                          border: OutlineInputBorder(
                              ...
                              borderSide: const BorderSide(
                                  color: MyColors.color_EBF0FA, width: 1)),
                  ...
                  IconButton(
                      ...
                      icon: SvgPicture.asset("a_assets/images/ic_sorting.svg"))
                ],
              ),
            ],
          ),
                            ...
                            return Slidable(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  ...
                                  sharedPreferences.setString("recpi_id",
                                      _searchResult[index].id.toString());
                                  ...
                                  sharedPreferences.setString(
                                      ...
                                      _searchResult[index]
                                          .phonecode
                                          .toString());
                                  sharedPreferences.setString("recipientId",
                                      _searchResult[index].id.toString());
                                  sharedPreferences.setString("senderId",
                                  ...
                                  sharedPreferences.setString(
                                      ...
                                      _searchResult[index]
                                          .firstName
                                          .toString());
                                  sharedPreferences.setString("lastname",
  ...
  onSearchTextChanged(String text) async {
    ...
    print("recipientlist text>>>> ${_recipientResult.length}");
    _searchResult.clear();
    if (text.isEmpty) {
      setState(() {});
      return;
    ...
    _recipientResult.forEach((userDetail) {
      print(userDetail.firstName.toString());
  ...
  void _searchFilter(String enteredKeyword) {
    ...
    if (enteredKeyword.isEmpty) {
      ...
      results = _recipientResult
          .where((user) => (user.firstName.toString()+" "+user.lastName.toString() +" "+  user.phonecode.toString()+user.phoneNumber.toString()).toString()
              .toLowerCase()
              ...
              InkWell(
                  onTap: () async {
                            ...
                            ? recipientlist.partnerPaymentMethod.toString() ==
                                ...
                                : pushNewScreen(
                                    ...
                                    screen:  SelectPaymentMethodScreen(
                                      isAlreadyRecipient: true,
                                      isMfs: recipientlist.partnerPaymentMethod.toString() == "mfs" ? true:false,
                                    ),
                                    withNavBar: false,
                                  )
                    ...
                    SharedPreferences sharedPreferences =
                        await SharedPreferences.getInstance();
                    sharedPreferences.setString(
                        "recpi_id", recipientlist.id.toString());
                    sharedPreferences.setString(
                        "recpi_userId", recipientlist.userId.toString());
                    sharedPreferences.setString(
                        "recipientId", recipientlist.recipientId.toString());
                    sharedPreferences.setString(
                        "iso2", recipientlist.countryIso2Code.toString());
                    sharedPreferences.setString(
                        "currency", recipientlist.currencyIso3Code.toString());
                    sharedPreferences.setString(
                        "rec_address", recipientlist.address.toString());
                    sharedPreferences.setString(
                        "rec_city", recipientlist.city.toString());
                    sharedPreferences.setString(
                        "postcode", recipientlist.postcode.toString());
                    sharedPreferences.setString(
                        "relationship", recipientlist.relationship.toString());
                    sharedPreferences.setString(
                    ...
                    sharedPreferences.setString(
                        "country_Name", recipientlist.countryName.toString());
                    sharedPreferences.setString(
                        "country_Flag", recipientlist.countryEmoji.toString());
                    sharedPreferences.setString(
                        "iso3", recipientlist.countryIso3Code.toString());
                    sharedPreferences.setString(
                        "iso2", recipientlist.countryIso2Code.toString());
                    sharedPreferences.setString("country_isoCode3",
                        recipientlist.countryIso3Code.toString());
                    sharedPreferences.setString("country_Currency_isoCode3",
                        recipientlist.currencyIso3Code.toString());
                    sharedPreferences.setString(
                        "phonecode", recipientlist.phonecode.toString());
                    sharedPreferences.setString(
                        "phonenumber_min_max_validation", "");
                    sharedPreferences.setString(
                        "currency", recipientlist.currencyIso3Code.toString());
                    sharedPreferences.setString("partnerPaymentMethod",
                        recipientlist.partnerPaymentMethod.toString());
                    sharedPreferences.setString(
                        "recipientReceiveBankOrMobileNo",
                        recipientlist.phonecode.toString() +
                    ...
                    sharedPreferences.setString(
                        "recipientId", recipientlist.recipientId.toString());
                    sharedPreferences.setString(
                        "senderId", "23cab527-e802-4e49-8cc1-78e5c5c8e8df");
                    sharedPreferences.setString(
                        "firstName", recipientlist.firstName.toString());
                    sharedPreferences.setString(
                        "lastname", recipientlist.lastName.toString());
                    sharedPreferences.setString(
                        "u_first_name", recipientlist.firstName.toString());
                    sharedPreferences.setString(
                        "u_last_name", recipientlist.lastName.toString());
                    sharedPreferences.setString(
                        "u_phone_number", recipientlist.phoneNumber.toString());
                    sharedPreferences.setString(
                        "u_profile_img", recipientlist.profileImage.toString());
                  },
                  child: Container(
                      //width: 40,
...
class _RecipentScreenState extends State<RecipentScreen> {
                                ...
                                children: [
                                  Container(
                                      child: InkWell(
                                          ...
                                          child: SvgPicture.asset(
                                            "a_assets/icons/recipent_icon/heart.svg",
                                            color: is_fav
                                  ...
                                  InkWell(
                                      ...
                                      child: SvgPicture.asset(
                                        "a_assets/icons/recipent_icon/swap.svg",
                                        color: is_sort
                                            ? MyColors.btncolor
                                            : MyColors.blackColor,
                                      )),
                                  ...
                                  GestureDetector(
                                      ...
                                      child: SvgPicture.asset(
                                          "a_assets/icons/recipent_icon/search.svg")),
                                ],
                              )
                            ],
                          ),
  ...
  onSearchTextChanged(String text) async {
    print("enter text>>>> " + text);
    print("recipientlist text>>>> " + _recipientResult.length.toString());
    _searchResult.clear();
    if (text.isEmpty) {
      setState(() {});
      return;
          ...
          child: CircleAvatar(
            ...
            child: ClipRRect(
              ...
              child: FadeInImage(
                ...
                placeholder: AssetImage("a_assets/logo/progress_image.png"),
                placeholderFit: BoxFit.scaleDown,
                imageErrorBuilder: (context, error, stackTrace) {
                  return Text(
                      txnsubdata.recipientName.toString()[0].toUpperCase(),
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Container(
                      //width: 40,
                      margin: EdgeInsets.only(left: 20),
                      child: SvgPicture.asset("a_assets/icons/send_blue.svg")),
                ),
              ],
            ),
          ),
