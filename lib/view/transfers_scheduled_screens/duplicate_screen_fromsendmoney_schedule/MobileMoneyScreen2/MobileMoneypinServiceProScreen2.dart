...
class MobileMoneypinServiceProScreen2 extends StatefulWidget{
  ...
  @override
  State<MobileMoneypinServiceProScreen2> createState() => _MobileMoneypinServiceProScreen2State();
}

class _MobileMoneypinServiceProScreen2State extends State<MobileMoneypinServiceProScreen2> {
                                      ...
                                      GestureDetector(
                                        ...
                                        onTap: (){
                                          print("shivangi");
                                            ...
                                            Navigator.push(context, MaterialPageRoute(builder: (context)=>SelectPayMethScheduleScreen2(selectedMethodScheduleScreen: 2,)));
                                            },
                                        child:
                                        Container(
                                          alignment: Alignment.center,
