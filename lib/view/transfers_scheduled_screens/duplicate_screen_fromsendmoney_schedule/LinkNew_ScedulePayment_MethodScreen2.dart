...
class  LinkNewScedulePaymentMethodScreen2 extends StatefulWidget{
  ...
  @override
  State<LinkNewScedulePaymentMethodScreen2> createState() => _LinkNewScedulePaymentMethodScreen2State();
}

class _LinkNewScedulePaymentMethodScreen2State extends State<LinkNewScedulePaymentMethodScreen2> {
  @override
                          ...
                          child: Card(
                            ...
                            child: Column(
                              children: [
                                ...
                                GestureDetector(
                                  onTap: (){
                                    Navigator.push(context, MaterialPageRoute(builder: (context)=>SelectBankScreen2()));
                                  },
                                  child:
                                  Container(
                                      width: size.width,
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            SizedBox(width: 24,),
                                            Text(MyString.bank_acount,style: TextStyle(color:MyColors.color_text,fontSize:14,fontWeight: FontWeight.w500,fontFamily: "s_asset/font/raleway/raleway_medium.ttf"),),
                                ...
                                GestureDetector(
                                  onTap: (){
                                    Navigator.push(context, MaterialPageRoute(builder: (context)=>DebitCardScreen2()));
                                  },
                                  child: Container(
                                      width: size.width,
                                ...
                                GestureDetector(
                                  onTap: (){
                                    Navigator.push(context, MaterialPageRoute(builder: (context)=>SelectServiceProviderScreen(isMfs: widget.isMfs,)));
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            SizedBox(width: 24,),
                                            Text("Mobile Money",style: TextStyle(color:MyColors.color_text,fontSize:14,fontWeight: FontWeight.w500,fontFamily: "s_asset/font/raleway/raleway_medium.ttf"),),
