...
class _HomeHistoryScreenState extends State<HomeHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _enabled==true?Utility.shrimmerVerticalListLoader(100, MediaQuery.of(context).size.width):
  ...
  void _searchFilter(String enteredKeyword) {
    ...
    if (enteredKeyword.isEmpty) {
      ...
      results = _latesttransferResult.where((user) => (user.recipientName.toString()+" "+user.phonecode.toString()+user.phoneNumber.toString()).toString().toLowerCase().contains(enteredKeyword.toLowerCase())).toList();
