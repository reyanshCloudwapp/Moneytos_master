...
class SelectBankScreen2BankDeposit extends StatefulWidget {
  const SelectBankScreen2BankDeposit({Key? key}) : super(key: key);

  @override
  State<SelectBankScreen2BankDeposit> createState() => _SelectBankScreen2BankDeposit();
}

class _SelectBankScreen2BankDeposit extends State<SelectBankScreen2BankDeposit> {
  ///Textfield contrller
            ...
            GridView(
              ...
              children:List.generate(selectbankposts.length, (index) {
                return GestureDetector(
                  onTap: (){
                    // Navigator.push(context, MaterialPageRoute(builder: (context)=>BankAccountNumber(bank_name:  selectbankposts[index].name.toString(),bank_id:selectbankposts[index].id.toString())));
                  },
                  child: Container(
