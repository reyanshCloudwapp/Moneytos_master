          ...
          child: AppBar(
              ...
              child: Row(
                ...
                children: [
                        ...
                        children: [
                          ...
                          Container(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                    color:
                                        MyColors.whiteColor.withOpacity(0.50),
                  ...
                  Container(
                      ...
                      //     alignment: Alignment.topRight,
                      //     child: SvgPicture.asset(
                      //         "a_assets/icons/edit_recipient.svg"),
                      //   ),
                      // ),
                      )
                ],
            ...
            /*  actions: [
              Container(
                ...
                alignment: Alignment.topRight,
                child: SvgPicture.asset(
                  "a_assets/icons/notification.svg",
                  height: 30,
                  width: 30,
                ),
              ),
                            ...
                            onTap: () async {
                              if(bankListResponse.status == true){
                                ...
                                await SharedPreferences
                                    .getInstance();
                                print("widget.recipientlist.partnerPaymentMethod.toString()>>>>  "+sharedPreferences.getString("select_payment_method_status").toString());

                                !state_verified? Utility().stateDialog(context):
                                doucument_status == "Approved"
                                    ?
                                widget.recipientlist.partnerPaymentMethod.toString() == "nium"?
                                ...
                                pushNewScreen(
                                  ...
                                  SendMoneyQuotationFromNewRecipient(
                                    isMobileMoney: sharedPreferences.getString("select_payment_method_status").toString()=="Mobile"?true:false,
                                    isAlreadyRecipient: true,
                                  ),
                                  withNavBar: false,
                                )
                                ...
                                sharedPreferences.setString("recpi_id", widget.recipientlist.id.toString());
                                sharedPreferences.setString("recpi_userId", widget.recipientlist.userId.toString());
                                sharedPreferences.setString("recipientId", widget.recipientlist.recipientId.toString());
                                sharedPreferences.setString("iso2", widget.recipientlist.countryIso2Code.toString());
                                sharedPreferences.setString("currency", widget.recipientlist.currencyIso3Code.toString());
                                sharedPreferences.setString("rec_address", widget.recipientlist.address.toString());
                                sharedPreferences.setString("rec_city", widget.recipientlist.city.toString());
                                sharedPreferences.setString("postcode", widget.recipientlist.postcode.toString());
                                sharedPreferences.setString("relationship", widget.recipientlist.relationship.toString());
                                sharedPreferences.setString("country_Name", widget.recipientlist.countryName.toString());
                                sharedPreferences.setString("country_Flag", widget.recipientlist.countryEmoji.toString());
                                sharedPreferences.setString("iso3", widget.recipientlist.countryIso3Code.toString());
                                sharedPreferences.setString("iso2", widget.recipientlist.countryIso2Code.toString());
                                sharedPreferences.setString("country_isoCode3", widget.recipientlist.countryIso3Code.toString());
                                sharedPreferences.setString("country_Currency_isoCode3", widget.recipientlist.currencyIso3Code.toString());
                                sharedPreferences.setString("phonecode", widget.recipientlist.phonecode.toString());
                                sharedPreferences.setString("phonenumber_min_max_validation", "");
                                sharedPreferences.setString("currency", widget.recipientlist.currencyIso3Code.toString());
                                sharedPreferences.setString("recipientId", widget.recipientlist.recipientId.toString());
                                sharedPreferences.setString("senderId", "23cab527-e802-4e49-8cc1-78e5c5c8e8df");
                                sharedPreferences.setString("firstName", widget.recipientlist.firstName.toString());
                                sharedPreferences.setString("lastname", widget.recipientlist.lastName.toString());
                                sharedPreferences.setString("u_first_name", widget.recipientlist.firstName.toString());
                                sharedPreferences.setString("u_last_name", widget.recipientlist.lastName.toString());
                                sharedPreferences.setString("u_phone_number", widget.recipientlist.phoneNumber.toString());
                                sharedPreferences.setString("u_profile_img", widget.recipientlist.profileImage.toString());
                              }else{
                                Utility.showFlutterToast("Please Select Payment Method");
                              }

                            },
                            child: SvgPicture.asset(
                              "a_assets/icons/send_blue.svg",
                              height: 20,
                              width: 20,
                            ),
                          ),
                                                                    ...
                                                                    InkWell(
                                                                        onTap:
                                                                          ...
                                                                          print("recipient_account_id" +
                                                                              bankListResponse.data![index].id.toString());
                                  ...
                                  GestureDetector(
                                    ...
                                    onTap: () async {
                                      ...
                                      sharedPreferences =
                                          await SharedPreferences
                                          .getInstance();
                                      widget.recipientlist.partnerPaymentMethod.toString() == 'mfs' || widget.recipientlist.partnerPaymentMethod.toString() == 'juba'?
                                      pushNewScreen(
                                        context,
                                        screen:
                                        SelectPaymentMethodScreen(recipientdtl: true,Oncallback: Update,isMfs: true,),
  ...
  CustomTransactionList(TxnSubData txnSubData) {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          border: Border.all(
              color: MyColors.lightblueColor.withOpacity(0.03), width: 1)),
      child: Material(
        color: MyColors.whiteColor,
        elevation: 2,
          ...
          child: Column(
            children: [
              Container(
                  ...
                  child: Text(
                    txnSubData.deliveryMethodType == "Bank" ?  "Bank Deposit" : "Mobile Deposit",
                    style: const TextStyle(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                DeleteBankAccountApi(
                                    context, recipientId, recipient_account_id);
