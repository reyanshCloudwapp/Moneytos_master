...
class PrivacyPolicyScreen extends StatefulWidget {
  ...
  @override
  State<PrivacyPolicyScreen> createState() => _TermsNConditionState();
}

class _TermsNConditionState extends State<PrivacyPolicyScreen> {
  ...
  void initState() {
    ...
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) => privacypolicyapi(context));
  }
  @override
  ...
  Future<void> privacypolicyapi(BuildContext context) async {
    ...
    var response = await http.get(Uri.parse(Apiservices.privacypolicyapi),
