...
class CreateAccountScreen extends StatefulWidget{
  ...
  CreateAccountScreen(this.fullname,this.lastname, this.pass,this.email,this.referralCode);
...
//you will get token here in the console
                ...
                Container(
                    ...
                    child: Align(
                        ...
                        child: SvgPicture.asset(
                          'a_assets/images/logo.svg', fit: BoxFit.cover,))),
              ],
            ),
          ),
        ),
  ...
  Future <void> selectCountryListApi(BuildContext context,) async {
    ...
    var response = await http.get(Uri.parse(AllApiService.SignupCountries_List_URL),
    ...
    return Container(
      ...
      ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return InkWell(
              onTap: (){
                cityController.text = selectStateList[index].name.toString();
