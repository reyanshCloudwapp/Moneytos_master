...
import 'package:moneytos/ScheduledTransferScreens/scheduled_go_toreview_screen.dart';
...
import '../view/home/s_home/debitcardscreen/edit_debit_cardscreen.dart';
import '../view/select_payment_method_screen/edit_bank_details_screen.dart';
...
class ScheduledSelectPaymentMethodScreen extends StatefulWidget {
 ...
 ScheduledSelectPaymentMethodScreen({Key? key,required this.selectedMethodScreen,required this.isMfs}) : super(key: key);

  @override
  State<ScheduledSelectPaymentMethodScreen> createState() => _ScheduledSelectPaymentMethodScreenState();
}

class _ScheduledSelectPaymentMethodScreenState extends State<ScheduledSelectPaymentMethodScreen> {
        ...
        onTap: (){
          ...
          if(SelectedMethod == 0){
            if(is_bankselect){
              pushNewScreen(
                context,
                screen: ScheduledGotoreviewScreen(selected_acc_id: selected_acc_id, selected_acc_name: selected_acc_name, selected_payment_type: selected_payment_type, selected_last4: selected_last4,),
                withNavBar: false,
              );
            }else{
...
*/
                  ...
                  GestureDetector(
                    ...
                    onTap: (){
                            ...
                            pushNewScreen(
                              context,
                              screen: SelectServiceProviderScreen(isMfs: widget.isMfs),
                              withNavBar: false,
                            );
                    },
                    child: Container(
