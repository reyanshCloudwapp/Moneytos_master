...
class ScheduledBankDetailsScreen extends StatefulWidget{
  ...
  @override
  State<ScheduledBankDetailsScreen> createState() => _ScheduledBankDetailsScreenState();
}

class _ScheduledBankDetailsScreenState extends State<ScheduledBankDetailsScreen> {
  ...
  Future<void> paymentmethodsRequest(BuildContext context,String name,String routing_number,String sec_code,String account_number) async {
    ...
    if(response.statusCode==200){
      ...
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>ScheduledSelectPaymentMethodScreen(selectedMethodScreen: 0,isMfs: widget.isMfs,)));
    }else{
      CustomLoader.ProgressloadingDialog(context, false);
      Map<String, dynamic> jsonResponse = convert.jsonDecode(response.body);
