...
import 'ScheduledSelectBankScreen2BankDeposit.dart';


class ScheduledSelectDeliveryMethodScreen extends StatefulWidget{

  @override
  State<ScheduledSelectDeliveryMethodScreen> createState() => _ScheduledSelectDeliveryMethodScreenState();
}

class _ScheduledSelectDeliveryMethodScreenState extends State<ScheduledSelectDeliveryMethodScreen> {
          ...
          //  hSizedBox3,
            GestureDetector(
              onTap: (){
                ...
                is_check = true;
                Navigator.push(context, MaterialPageRoute(builder: (context)=>const ScheduledSelectBankScreen2BankDeposit()));
              },
              child: Container(
            ...
            GestureDetector(
              onTap: (){
                is_check = true;
                Navigator.push(context, MaterialPageRoute(builder: (context)=>BankDepositDeliveryMethodScreen(MyString.mobile_money)));
              },
              child: Container(
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: const Row(
                                  ...
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    Text("1.50",style: TextStyle(color: MyColors.color_text,fontSize:15,fontFamily: "s_asset/font/raleway/raleway_bold.ttf",fontWeight: FontWeight.w800,),),
            ...
            GestureDetector(
              onTap: (){
                ...
                is_check = true;
                Navigator.push(context, MaterialPageRoute(builder: (context)=>BankDepositDeliveryMethodScreen(MyString.Cash_Pickup)));
                    ...
                    child: Row(
                      children: [
                        ...
                        const Column(
                          ...
                          children: [
                            Text(MyString.Cash_Pickup,style: TextStyle(color:MyColors.color_text,fontSize:16,fontWeight: FontWeight.w500,fontFamily: "s_asset/font/raleway/raleway_medium.ttf"),),
                            hSizedBox,
                            Padding(
                              ...
                              child: Row(
                                ...
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Text("3.00",style: TextStyle(color: MyColors.color_text,fontSize:15,fontFamily: "s_asset/font/raleway/raleway_bold.ttf",fontWeight: FontWeight.w800,),),
                                  Text(" USD",style: TextStyle(color: MyColors.color_text,fontSize:12,fontFamily: "s_asset/font/raleway/raleway_medium.ttf",fontWeight: FontWeight.w600, ),)
                                ],
                              ),
                            ),                    ],
