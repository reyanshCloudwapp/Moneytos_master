...
class _ScheduleRecipientDetailScreenState
  ...
  getaccountitemdetailApi(
    ...
    await AccountDetailsitemRequest(context, accountdetaillist2,
        accountdetailfieldsetlist2, recipentid, receipent_account_id);
    setState(() {
      itemload = false;
    });
                      ...
                      child: TextField(
                        ...
                        onChanged: (String value) async {
                          if (value.isEmpty) {
                            ...
                            print(
                                "totalCostFee>>>>>>" + totalCostFee.toString());
                            ...
                            if (Is_transaction_fees_free == "1") {
                              if (sendAmt >=
                                ...
                                send_moneytos =
                                    transfer_fees > 0 ? 0 : moneytos;
                                sharedPreferences.setString(
                                    "monyetosfee", send_moneytos.toString());
                              }
                            } else {
          ...
          children: [
            ...
            Container(
              padding: const EdgeInsets.only(
                  top: 50, left: 25, right: 25, bottom: 80),
              //  alignment: Alignment.center,
              child: GestureDetector(
                onTap: () {
                  Navigator.pop(context);
