...
class ScheduleRecipientDetailScreen extends StatefulWidget{
  ...
  String countryEmoji;
  ScheduleRecipientDetailScreen(this.recipient_firstname,this.recipient_lastname,this.img,this.countryIso3Code,this.phonecode,this.phone_number,this.country_name,this.recipientId,this.currencyIso3Code,this.countryEmoji);

  @override
  State<ScheduleRecipientDetailScreen> createState() => _ScheduleRecipientDetailScreenState();
}

class _ScheduleRecipientDetailScreenState extends State<ScheduleRecipientDetailScreen> {
  ...
  Future<void> loadPref() async {
     ...
     sharedPreferences!.setString("country_Currency_isoCode3",widget.currencyIso3Code);
  ...
  getaccountitemdetailApi(String recipentid,String receipent_account_id)async{
    ...
    setState((){
      ...
      print("accountdetaillist2>>> "+accountdetaillist2[0].dstCountryIso3Code.toString());
    });
  }
  ...
  Future<void> AccountDetailsitemRequest(BuildContext context,List<AccountsDetailModel> accountdetaillist,List<AccountDetailFieldsModel> accountdetailfieldsetlist,String recipientid,String recipient_account_id
      ) async {
    // CustomLoader.ProgressloadingDialog(context, true);
                                ...
                                child: ClipRRect(
                                    ...
                                    child:  FadeInImage(
                                      ...
                                      imageErrorBuilder:
                                        ...
                                        return Container(alignment:Alignment.center,child: Text(widget.recipient_firstname.toString()[0].toUpperCase(),style: TextStyle(
        ...
        child: Stack(
          ...
          /*  is_country == "" ?   Container(
            ...
            SingleChildScrollView(
              child: is_country == "country" ? countrybody()
                  : is_country == "delivery_method" ? countryDelevery_paymentMathod() : is_country == "add_recipient"? addrecipientInfobody(): is_country == "select_bankdetail" ? SelectbankDetailBody() :
              Container(
                height: size.height,
                padding: EdgeInsets.symmetric(horizontal: 20, vertical: 0),
                width: double.infinity,
                              ...
                              children: [
                                Row(
                                  children: [
                                    SvgPicture.asset("s_asset/images/flag2.svg",width: 26,height: 26,),
                                    wSizedBox1,
                                    Text(country_name,style: TextStyle(fontSize: 14,fontFamily: "s_asset/font/raleway/raleway_medium.ttf",fontWeight: FontWeight.w500,color: MyColors.color_text),),
                                  ],
                                ),
                                Container(
                                    width: 50,
...
*/
                      ...
                      return Container(
                        child: GestureDetector(
                          onTap: () async {
                            ...
                            country_name = selectCountryList[index].name.toString();
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        style: TextStyle(fontSize: 25,fontFamily: "s_asset/font/montserrat/Montserrat-ExtraBold.otf",
                            fontWeight: FontWeight.w700,color: MyColors.blackColor),),
                    ),
                    Row(
                      children: [
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: TextField(
                          ...
                          style: TextStyle(fontSize: 25,fontFamily: "s_asset/font/montserrat/Montserrat-ExtraBold.otf",fontWeight: FontWeight.w700,color: MyColors.blackColor),
                        )
                    ),
                    ...
                    Row(
                      children: [
                        ...
                        Text(destcountryCurrency_isoCode3,style: TextStyle(fontSize: 18,fontFamily: "s_asset/font/raleway/raleway_bold.ttf",fontWeight: FontWeight.w700,color: MyColors.color_text),),
                        /*  wSizedBox,
      ...
      child: Column(
        children: [
          ...
          Container(
              ...
              alignment: Alignment.center,
              child: Text(MyString.Add_Recipient_Info,style: TextStyle(color: MyColors.color_text,fontSize:18,fontFamily: "s_asset/font/raleway/raleway_semibold.ttf",fontWeight: FontWeight.w600,letterSpacing: 0.1 ),)),
              ...
              itemBuilder: (context,int i){
                ...
                return   Container(
                  ...
                  child: TextFormField(
                    ...
                    // firstnameController,
                    enabled: recipientfieldsetlist[i].fieldId == "ADDRESS_COUNTRY" ? false: true,
                    ...
                    onFieldSubmitted: (String value){
                      AddRecipientFieldModel addmodel =   AddRecipientFieldModel(id:recipientfieldsetlist[i].fieldId.toString(),type:recipientfieldsetlist[i].fieldType.toString(),value :value);
                      addfieldlist.add(addmodel);
                      print("json..${json.encode(addfieldlist)}");
                    },
                    style: TextStyle(
                    ...
                    decoration: InputDecoration(
                      hintText:recipientfieldsetlist[i].fieldId == "ADDRESS_COUNTRY" ?  "${p!.getString("country_Name")}" : recipientfieldsetlist[i].name,
                      hintStyle: TextStyle(color:recipientfieldsetlist[i].fieldId == "ADDRESS_COUNTRY" ? MyColors.blackColor: MyColors.color_text.withOpacity(0.4),fontSize: 12,fontFamily: "s_asset/font/raleway/raleway_medium.ttf",fontWeight: FontWeight.w500 ),
          ...
          GestureDetector(
            onTap: (){
              ...
              for(int j= 0; j < recipientfieldsetlist.length ; j++){
                recipientfieldsetlist[j].fieldId == "ADDRESS_COUNTRY" ?  recipientfieldsetlist[j].value  =  "${p!.getString("country_isoCode3")}" : "";
                setState((){});
  ...
  CustomText(String text){
    ...
    //  height: 40,
      ...
      child: Text(text,style: TextStyle(color: MyColors.blackColor,fontSize: 12,fontFamily: "s_asset/font/raleway/raleway_medium.ttf",fontWeight: FontWeight.w500),),
    );
  }
...
*/
                            ...
                            GestureDetector(
                              ...
                              onTap: (){
                                ...
                                pushNewScreen(
                                  context,
                                  screen: RecipientDetailBankAccountNumber(Oncallback: Update,),
                      ...
                      Container(
                        ...
                        child: GestureDetector(
                          onTap: () async {
                            ...
                            print("object"+json.encode(bankdetailreponse));
                            sharedPreferences.setString("BankdetailResponse", json.encode(bankdetailreponse));
                            Navigator.push(context, MaterialPageRoute(builder: (_) => ReasonforSendingScreen(status: "schedule_already_add",)));
                            setState((){});
                          },
                          child: Container(
                            alignment: Alignment.center,
