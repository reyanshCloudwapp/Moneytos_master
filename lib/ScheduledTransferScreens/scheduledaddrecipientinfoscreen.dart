...
import 'package:moneytos/ScheduledTransferScreens/scheduledselectdeliverymethod.dart';
    ...
    try {
      ...
      response.stream.transform(convert.utf8.decoder).listen((event) {
        ...
        if (map["status"] == true) {
          ...
          Navigator.push(context, MaterialPageRoute(builder: (context)=>ScheduledBankAccountNumber()));
    ...
    try {
      ...
      response.stream.transform(convert.utf8.decoder).listen((event) {
        ...
        if (map["status"] == true) {
          CustomLoader.ProgressloadingDialog(context, false);
          pre.setString("recpi_id", map['data']['recipient_server_id'].toString());
          Navigator.push(context, MaterialPageRoute(builder: (context)=>ScheduledSelectDeliveryMethodScreen()));
