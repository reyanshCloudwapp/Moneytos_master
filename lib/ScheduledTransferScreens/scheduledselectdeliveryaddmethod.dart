...
import 'Scheduledreasonforsendingscreen.dart';
...
class ScheduledSelectDeliveryAddMethodScreen extends StatefulWidget{
  ...
  @override
  State<ScheduledSelectDeliveryAddMethodScreen> createState() => _ScheduledSelectDeliveryAddMethodScreenState();
}



class _ScheduledSelectDeliveryAddMethodScreenState extends State<ScheduledSelectDeliveryAddMethodScreen> {
          ...
          children: [
            ...
            GestureDetector(
              onTap: () async {
                ...
                Navigator.push(context, MaterialPageRoute(builder: (_) => ReasonforSendingScreen(status: "schedule_reason_for_sending",)));
