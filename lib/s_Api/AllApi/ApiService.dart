class AllApiService{
  ...
  static String AllrecipientProImageBaseUrl = "https://itmates.digital/moneytos/public/recipientProfileImages/";
  ...
  static String statelistbycountryid_List_URL = bashurl + "statelistbycountryid";
 ...
 // static const Countries_List_URL = bashurl + "coutries";
  ...
  static String get_txn_status_URL = "https://sandbox-api.readyremit.com/v1//transfers/";

  //All Api readyremit  (Punit Apis)
  static String transactions_verifyURL = magicpayBaseUrlBaseUrl+"transactions/verify";
  ...
  static String transaction_chargeURL = magicpayBaseUrlBaseUrl+"transactions/charge";
  ...
  static String DeleteBankCardURL = bashurl+"deleteMagicpaySenderPaymentMethod";
  static String EditDebitCardURL = bashurl+"editMagicpaySenderCard";
  static String TransfersURL = "https://sandbox-api.readyremit.com/v1/Transfers";
  ...
  static String deleteRecipientBankAccountURL = bashurl+"deleteRecipientBankAccount";
  static String mfsbanklistBycountryiso2URL = bashurl+"mfsbanklistBycountryiso2";
  static String chkStateStatusByIpURL = bashurl+"chkStateStatusByIp";
  static String pickuplocationsbycountryiso3URL = bashurl+"pickup-locations-by-country-iso3";
