            ...
            Row(
              children: [
                    ...
                    child: FadeInImage(
                      ...
                      imageErrorBuilder:
                        ...
                        return Container(
                            ...
                            alignment:Alignment.center,child: Text(recipient_name.toString()[0].toUpperCase(),style: const TextStyle(
                ...
                Container(
                  ...
                  child: Text(recipient_name,style: const TextStyle(color: MyColors.blackColor,fontWeight: FontWeight.w500,fontSize: 15,letterSpacing: 0.5),),
                ),
              ],
            ),
              ...
              child:  Row(
                ...
                children: [
                  Container(
                    ...
                    alignment: Alignment.topLeft,
                    child: Text(double.parse(amount).toStringAsFixed(2),style: const TextStyle(color: MyColors.blackColor,fontSize: 24,fontWeight: FontWeight.w600),),
                  ),
                  wSizedBox,
                  Container(
                    alignment: Alignment.topLeft,
                    child: const Text(MyString.usd,style: TextStyle(color: MyColors.blackColor,fontSize: 12,fontWeight: FontWeight.w700),),
                  ),
                ],
              ),
            ),
