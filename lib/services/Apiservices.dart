...
class Apiservices {
  ...
  static String submitContactNumber = AllApiService.bashurl+"submitContactNumber";
  static String verifyOtpWithRegister = AllApiService.bashurl+"verifyOtpWithRegister";
  ...
  static String verifyForgotPasswordOtp = AllApiService.bashurl+"verifyForgotPasswordOtp";
  ...
  static String uploadedDocumentDetail = AllApiService.bashurl+"uploadedDocumentDetail";
  static String addrecipientfield = "https://sandbox-api.readyremit.com/v1/recipients";
  static String accountDetailapi = "https://sandbox-api.readyremit.com/v1/recipients/";
  static String chartRecipientapi = AllApiService.bashurl+"graphTxn";
  static String createRTxnbyMtxnidapi = AllApiService.bashurl+"createRTxnbyMtxnid";
  ...
  static String favouriteRecipientapi = AllApiService.bashurl+"favouriteRecipient";
  static String scheduleTransferListapi = AllApiService.bashurl+"scheduleTransferList";
  static String changeScheduleStatusapi = AllApiService.bashurl+"changeScheduleStatus";
  static String favouriteRecipientListapi = AllApiService.bashurl+"favouriteRecipientList";
  static String chkEmailAndRefferalCodeapi = AllApiService.bashurl+"chkEmailAndRefferalCode";
  static String notificationlistapi = AllApiService.bashurl+"notificationlist";
  ...
  static String updateNotificatinsapi = AllApiService.bashurl+"updateNotificatins";
  ...
  static String updateRediremitTxnStatusapi = AllApiService.bashurl+"updateRediremitTxnStatus";
  static String cancelScheduleapi = AllApiService.bashurl+"cancelSchedule";
  static String addRecipientBankAccountapi = AllApiService.bashurl+"addRecipientBankAccount";
  static String editrecipientBankAccountapi = AllApiService.bashurl+"editrecipientBankAccount";
  static String recipientBankAccountsapi = AllApiService.bashurl+"recipientBankAccounts";
  static String txnDetailapi = AllApiService.bashurl+"txnDetail";
  static String countryWiseExchangeRateapi = AllApiService.bashurl+"countryWiseExchangeRate";
  static String niumPurposeCodesapi = AllApiService.bashurl+"niumPurposeCodes";
  static String countryDetailByIso3api = AllApiService.bashurl+"country-detail-by-iso3";

  // ------------------------ nium base url --------------------------
  static String authenticationapi = nium_base_url+"authentication";
  static String bookfxapi = nium_base_url+"bookfx";
  static String niumRoutingCodeTypesapi = AllApiService.bashurl+"niumRoutingCodeTypes";
  static String niumpayoutsapi = nium_base_url_v2+"payouts";
  static String searchbanknamebyifscapi = AllApiService.bashurl+"niumRoutingCodeSearch";
